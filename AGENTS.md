...
Behavioral Summary
	1.	Sequential Thinking MCP — guides logic and task breakdown.
	2.	Context7 MCP — verifies accuracy and updates from official docs.
	3.	Serena MCP — manages project execution, structure enforcement, and refactoring.
	4.	mcp-feedback-enhanced — manages iterative improvement and confirmation.
