...
echo "[3/13] Deploying create-checkout-session-by-email function..."
supabase functions deploy create-checkout-session-by-email --project-ref $PROJECT_REF
echo "OK: create-checkout-session-by-email deployed"
echo ""

echo "[4/13] Deploying verify-payment function..."
...
echo "[8/13] Deploying create-portal-session function..."
...
echo "   - moneko-web/supabase/migrations/20260404093000_add_subscription_entitlement_sources.sql"
echo "   - moneko-web/supabase/migrations/20260404143000_subscription_projection_hardening.sql"
echo "   - moneko-web/supabase/migrations/20260404173000_legacy_subscription_source_key_closure.sql"
echo ""
