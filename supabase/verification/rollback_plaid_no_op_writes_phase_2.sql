-- FUNCTION-ONLY ROLLBACK FOR PLAID DISK I/O PHASE 2.
-- Restore the Phase 1 v1 body and historical internal v2 legacy body only.
-- Never rerun historical lifecycle or atomic-sync migrations for rollback.
