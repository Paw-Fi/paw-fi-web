...
icon: string (Must be a valid FontAwesome React icon name: "faWandSparkles", "faPiggyBank", "faBriefcase", "faHandshake", "faUpLong", "faDollarSign", "faCalendar", "faTarget", "faLightbulb", "faLink", "faWallet", "faReceipt", "faCreditCard", "faBanknote", "faShieldCheck", "faBarChart2", "faLineChartIcon", "faChevronsRight", "faHome", "faCar")
