...
Task: Generate 4-6 short, concise, and relevant phrases that a user might typically respond with as a follow-up, clarification, or next logical step to their own question. These phrases should be suitable for display as clickable "choice buttons" above the input field.
...
Task: Generate 4-6 common, open-ended questions related to personal finance that a user might want to ask to initiate a conversation or explore financial topics. These should encourage engagement.
...
Output: ["Rental Income", "Dividends", ...Rest of your own suggestions]
`