...
function buildWelcomeEmailText(name: string, planLabel: string): string {
  return [
    ...
    "",
    "I’m Yifan, one of the co-founders at Moneko. We’re still early, so you’re not just using the product, you’re helping shape it.",
    "",
    "If anything feels confusing, missing, or just not quite right, just hit reply and tell me. I read every message myself.",
    "",
    "Out of curiosity, what made you decide to give Moneko a try?",
    "",
    "Thanks again for being part of this early.",
    "",
    "Yifan",
