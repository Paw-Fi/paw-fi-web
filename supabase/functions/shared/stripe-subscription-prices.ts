...
export const SUBSCRIPTION_PRICES = {
  ...
  // They will look like: price_1NcJX4KL6JzIj83kMgLtXyzB
    ...
    premium: {
      monthly: Deno.env.get("STRIPE_MONTHLY_PREMIUM_PLAN_ID"), // REPLACE: Your Premium plan monthly price ID from Stripe Dashboard
      yearly: Deno.env.get("STRIPE_YEARLY_PREMIUM_PLAN_ID"),   // REPLACE: Your Premium plan yearly price ID from Stripe Dashboard
    },
  }