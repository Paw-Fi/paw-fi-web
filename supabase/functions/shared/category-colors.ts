...
function buildGroupColorMap(categories: string[], palette: string[]): Record<string, string> {
...
export function normalizeCategory(raw: string | null): string {
  ...
  const plaidMappings: Record<string, string> = {
    ...
    'government_and_non_profit_other_government_and_non_profit': 'government services',
