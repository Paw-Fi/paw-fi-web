...
const staticRoutes: StaticRoute[] = [
  ...
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/invest-L1', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/behavfin-L2', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/moneymarket-L3', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/bondmarket-L4', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/equitymarket-L5', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/derivatives-L6', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/tvm-L7', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/stats-L8', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/econbasics-L9', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
  { path: '/dashboard/learning/your-2025-guide-to-investing/lesson/finstatements-L10', priority: 0.8, changefreq: 'weekly', lastmod: '2025-05-30' },
