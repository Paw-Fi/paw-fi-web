-- ====================
-- GOAL TRACKER QUESTIONNAIRE TEMPLATES - Seed Data
-- Created: 2025-01-28
-- Purpose: Initial questionnaire templates for different goal types
-- ====================

-- ====================
-- RETIREMENT GOAL TEMPLATE
-- ====================
INSERT INTO public.goal_questionnaire_templates (
  goal_type,
  template_name,
  description,
  questions,
  ...
  'AI-driven assessment to create your personalized retirement savings strategy',
  '[
    {
      "id": "current_age",
      "type": "number",
  ...
  'You are an expert financial advisor specializing in retirement planning. Based on the user''s questionnaire responses, create a comprehensive, personalized retirement savings strategy.
...
Make all content personalized, encouraging, and actionable.',
  '{"model": "gemini-2.5-flash", "temperature": 0.7, "max_tokens": 3000}',
  true,
  1
);
...
INSERT INTO public.goal_questionnaire_templates (
  ...
  'Create a personalized home buying savings strategy with timeline and milestones',
  '[
    {
  ...
  'You are a real estate financial advisor helping someone plan their home purchase. Create a comprehensive savings strategy based on their responses.
...
INSERT INTO public.goal_questionnaire_templates (
  ...
  'Develop a personalized wealth accumulation plan with investment strategy',
  '[
    {
      "id": "wealth_target",
      "type": "currency",
  ...
  'You are a wealth management advisor creating a personalized wealth building strategy. Focus on investment allocation, growth strategies, and milestone planning.
...
INSERT INTO public.goal_questionnaire_templates (
  ...
  'Create a targeted investment strategy for specific financial objectives',
  '[
    {
  ...
  'You are an investment advisor creating a personalized investment strategy. Focus on asset allocation, risk management, and performance tracking.
