...
begin
  if not exists (
    ...
    where table_schema = 'public'
      ...
      and column_name = 'analytics_is_final'
      and is_nullable = 'NO'
  ) or to_regprocedure(
    ...
    where tgrelid = 'public.expenses'::regclass
      and tgname = 'set_expense_analytics_classification_v1'
      and not tgisinternal
  ) then
    raise exception using
      errcode = '55000',
      message = 'Missing Plaid analytics prerequisite',
      hint = 'Run 20260716230000_plaid_analytics_classification.sql and 20260716233000_plaid_analytics_constraints.sql before 20260717120000_plaid_atomic_sync_and_review.sql';
  end if;
end;
$$;
