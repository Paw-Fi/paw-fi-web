-- A new month's first pocket review must still see confirmed spending already
-- recorded in that financial cycle. The v2 financial payload has no envelope
-- rows at this point, but that must not suppress its scoped, privacy-filtered
-- expense aggregates.
