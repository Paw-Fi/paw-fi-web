-- Phase 1: make Plaid transfer reconciliation set-based without changing
-- apply_plaid_sync_batch_v1/v2 contracts or lifecycle behavior.
-- The previous v1 body is preserved in
-- 20260717120000_plaid_atomic_sync_and_review.sql for rollback.
