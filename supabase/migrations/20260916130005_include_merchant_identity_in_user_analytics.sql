    ...
    'expenses', coalesce((
      ...
      from (
        select
          ...
          e.merchant_structured_name, e.receipt_image_url, e.household_id,
          e.split_group_id, e.type, e.is_recurring, e.bank_account_id,
          e.account_id, e.analytics_class, e.analytics_is_final,
