...
export interface UserGuidanceState {
  ...
  previousVisits?: Record<string, number>;
...
const GUIDANCE_SCENARIOS: GuidanceScenario[] = [
  // === ONBOARDING & ORIENTATION ===
  {
    ...
    agentId: "educator",
    message:
      "Welcome to Moneko! 👋 I'm Finni, your financial educator. This is your financial command center - let me show you around and help you start your journey!",
    priority: "high",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "advisor",
    message:
      "New here? I recommend starting with either Goal Tracker to set your first financial target, or Learning to build your foundation. What interests you most?",
    priority: "high",
    conditions: [
...

  {
    ...
    agentId: "educator",
    message:
      "You're making great progress! 🌟 I can see you've been exploring different sections. Ready to dive deeper into any particular area?",
    priority: "medium",
    conditions: [
  ...
  // === GOAL TRACKER SCENARIOS ===
  {
    ...
    agentId: "advisor",
    message:
      "Welcome to Goal Tracker! 🎯 This is where you turn your financial dreams into actionable plans. Ready to create your first goal?",
    priority: "high",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "advisor",
    message:
      "I see you don't have any goals yet. No worries! Let's start with something achievable - maybe an emergency fund or a vacation savings goal?",
    priority: "high",
    conditions: [
...

  {
    ...
    agentId: "advisor",
    message:
      "Excellent! You're creating your first goal. 🎉 Take your time here - a well-defined goal is the foundation of financial success. Need any tips?",
    priority: "high",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "advisor",
    message:
      "Congratulations on creating your first goal! 🎊 This is a huge step. I'm here to help you optimize your strategy and stay on track.",
    priority: "high",
    conditions: [
...

  {
    ...
    agentId: "advisor",
    message:
      "How's your progress going? 📈 Remember, small consistent contributions often beat large irregular ones. Want to review your strategy?",
    priority: "medium",
    conditions: [
      { type: "return_visit", value: true },
...

  {
    ...
    agentId: "advisor",
    message:
      "I noticed you might be falling behind on this goal. That's totally normal! 💪 Let's discuss some strategies to get back on track.",
    priority: "high",
    conditions: [
...

  {
    ...
    agentId: "advisor",
    message:
      "🎉 Amazing! You've hit a major milestone. This kind of progress shows real financial discipline. Ready to set an even bigger goal?",
    priority: "medium",
    conditions: [{ type: "goal_status", value: "milestone_reached" }],
    cooldownHours: 24,
    maxShowCount: 5,
  },

  {
    ...
    agentId: "advisor",
    message:
      "I love seeing multiple goals! 🌟 You're building a comprehensive financial plan. Want help prioritizing or balancing them?",
    priority: "medium",
    conditions: [
  ...
  // === LEARNING SCENARIOS ===
  {
    ...
    agentId: "educator",
    message:
      "Welcome to your Learning Hub! 📚 Knowledge is your best investment. I recommend starting with our essentials if you're new to finance.",
    priority: "high",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "educator",
    message:
      "Wondering about the difference? Essentials covers fundamental concepts, while Learning offers deeper, specialized topics. Which matches your experience level?",
    priority: "medium",
    conditions: [
      { type: "return_visit", value: true },
...

  {
    ...
    agentId: "educator",
    message:
      "Great choice! 👍 This course will really expand your financial knowledge. Take your time with each lesson - understanding is more important than speed.",
    priority: "medium",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "educator",
    message:
      "Your first lesson! 🚀 Every expert was once a beginner. Take notes and don't hesitate to chat with me if you have questions.",
    priority: "high",
    conditions: [
...

  {
    ...
    agentId: "educator",
    message:
      "Well done! 🎯 You completed another lesson. Consistency is key in learning. Ready for the next one, or want to apply what you learned first?",
    priority: "medium",
    conditions: [{ type: "user_action", value: "lesson_completed" }],
    cooldownHours: 1,
    maxShowCount: 10,
  },

  {
    ...
    agentId: "educator",
    message:
      "You're halfway through this course! 📖 The concepts are building on each other beautifully. How are you feeling about the material so far?",
    priority: "medium",
    conditions: [{ type: "user_action", value: "course_halfway_complete" }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "educator",
    message:
      "Course completed! 🏆 You should feel proud - you've gained valuable financial knowledge. Ready to apply it or explore another course?",
    priority: "high",
    conditions: [{ type: "user_action", value: "course_completed" }],
    maxShowCount: 1,
  },
  ...
  // === ESSENTIALS SCENARIOS ===
  {
    ...
    agentId: "educator",
    message:
      "Perfect choice for building your foundation! 🏗️ Essentials covers everything you need to make smart financial decisions. Let's start your journey!",
    priority: "high",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "educator",
    message:
      "This essentials course is perfectly structured for beginners! 📈 Each lesson builds on the previous one, so take them in order for the best experience.",
    priority: "medium",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "educator",
    message:
      "This fundamental concept will serve you well! 💡 Make sure you understand it fully before moving on - it's the building block for everything else.",
    priority: "medium",
    conditions: [
...

  {
    ...
    agentId: "educator",
    message:
      "Ready to put this knowledge into action? 🎯 Now might be a great time to create your first financial goal and apply what you've learned!",
    priority: "medium",
    conditions: [
  ...
  // === PORTFOLIO SCENARIOS ===
  {
    ...
    agentId: "advisor",
    message:
      "Welcome to your Portfolio Hub! 📊 This is where successful investors track their holdings. Ready to take your finances to the next level?",
    priority: "high",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "advisor",
    message:
      "Setting up your portfolio tracking might seem complex, but it's incredibly valuable! 💰 Start with your biggest holdings and build from there.",
    priority: "medium",
    conditions: [
      { type: "return_visit", value: true },
...

  {
    ...
    agentId: "advisor",
    message:
      "Want to be a smarter investor? 🧠 I notice you haven't explored our learning section yet. Investment education could really boost your portfolio performance!",
    priority: "medium",
    conditions: [
      { type: "return_visit", value: true },
...

  {
    ...
    agentId: "advisor",
    message:
      "Your portfolio is looking good! 📈 Want me to analyze your asset allocation and suggest improvements for better diversification?",
    priority: "medium",
    conditions: [
      { type: "return_visit", value: true },
  ...
  // === USER SETTINGS SCENARIOS ===
  {
    ...
    agentId: "advisor",
    message:
      "Smart move visiting your settings! ⚙️ A complete profile helps me give you much better personalized advice. Let's optimize your experience.",
    priority: "medium",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "advisor",
    message:
      "Your profile is the foundation of personalized advice! 👤 The more details you provide, the better recommendations I can make for your unique situation.",
    priority: "high",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "advisor",
    message:
      "I notice your profile isn't complete yet. 📝 Even basic info like your age and income goals helps me give much better financial advice!",
    priority: "medium",
    conditions: [
...

  {
    ...
    agentId: "advisor",
    message:
      "Interested in premium features? 👑 Our membership unlocks advanced calculators, detailed portfolio analysis, and exclusive investment strategies!",
    priority: "medium",
    conditions: [{ type: "first_visit", value: true }],
    maxShowCount: 1,
  },

  {
    ...
    agentId: "advisor",
    message:
      "I can see you're serious about your finances! 🌟 Premium members typically see 20% better goal achievement rates with our advanced tools and insights.",
    priority: "medium",
    conditions: [
  ...
  // === ENGAGEMENT & RETENTION ===
  {
    ...
    agentId: "advisor",
    message:
      "Welcome back! 😊 I'm excited to see you continuing your financial journey. What would you like to focus on today?",
    priority: "medium",
    conditions: [
      { type: "return_visit", value: true },
...

  {
    ...
    agentId: "educator",
    message:
      "You've been learning a lot! 🎓 Knowledge is powerful, but action creates wealth. Ready to set some financial goals based on what you've learned?",
    priority: "medium",
    conditions: [
...

  {
    ...
    agentId: "advisor",
    message:
      "Your goals are ambitious - I love it! 💪 Want to accelerate your progress? Our learning section has strategies specifically for goal achievement.",
    priority: "medium",
    conditions: [
...

  {
    ...
    agentId: "educator",
    message:
      "Wow! You're using goals, learning, AND portfolio tracking! 🏆 You're in the top 5% of users. Your financial future is looking incredibly bright!",
    priority: "medium",
    conditions: [
...

  {
    ...
    agentId: "advisor",
    message:
      "It's been a while! 🕐 Life gets busy, but your financial goals are still important. Let's do a quick check-in and get you back on track.",
    priority: "high",
    conditions: [
  ...
  // === CONTEXTUAL HELP ===
  {
    ...
    agentId: "advisor",
    message:
      "See me here on the right? 💬 I'm your personal financial advisor! Click anytime to ask questions, get advice, or discuss your financial situation.",
    priority: "medium",
    conditions: [
...

  {
    ...
    agentId: "educator",
    message:
      "Did you know you can track investment portfolios here too? 📊 Once you're comfortable with basic goals, portfolio tracking is the next level!",
    priority: "low",
    conditions: [
...

  {
    ...
    agentId: "advisor",
    message:
      "New year, new financial goals! 🎊 This is the perfect time to review your progress and set ambitious targets for the year ahead.",
    priority: "medium",
    conditions: [
  ...
  // === FREE TRIAL PROMOTION ===
  {
    ...
    agentId: "advisor",
    message:
      "🌟 Try Premium Free for 30 Days! This exclusive offer is available to our early users. Experience AI-powered coaching, advanced analytics, unlimited goal tracking, and priority support. No credit card required. Ready to unlock your full financial potential?",
    priority: "high",
    conditions: [{ type: "user_action", value: "eligible_for_trial" }],
...
class DashboardGuidanceMonitor {
  ...
  trackRouteChange(route: string, params: Record<string, string> = {}) {
    ...
    const previousVisit = this.userState.lastVisits[normalizedRoute] || 0;
    ...
    this.userState.routeVisits[normalizedRoute] =
      (this.userState.routeVisits[normalizedRoute] || 0) + 1;
    this.userState.previousVisits = {
      ...(this.userState.previousVisits || {}),
      [normalizedRoute]: previousVisit,
    };
    this.userState.lastVisits[normalizedRoute] = now;

    // Track first dashboard visit
    if (
      !this.userState.userJourney.firstDashboardVisit &&
    ...
    switch (action) {
      ...
      case "lesson_completed":
        if (data?.lessonId && data?.courseId) {
          ...
          if (
            !this.userState.userJourney.completedLessons.includes(data.lessonId)
          ) {
  ...
  private matchesRoute(scenarioRoute: string): boolean {
    const normalizedScenarioRoute = this.normalizeRoute(scenarioRoute);
    const routePattern = normalizedScenarioRoute.replace(/\{[^}]+\}/g, "[^/]+");
  ...
  private evaluateCondition(condition: GuidanceCondition): boolean {
    ...
    switch (condition.type) {
      ...
      case "time_since_last":
        const lastVisit =
          this.userState.previousVisits?.[this.currentRoute] || 0;
  ...
  private evaluateUserAction(action: string): boolean {
    switch (action) {
      ...
      case "first_goal_created":
        return (
          this.userState.userJourney.hasCreatedGoal &&
          Object.keys(this.userState.scenariosShown).length <= 3
        ); // Recent user

      case "first_lesson_started":
        return (
          this.userState.userJourney.completedLessons.length === 0 &&
      ...
      case "established_goal_user":
        return (
          this.userState.userJourney.hasCreatedGoal &&
          this.userState.totalVisits >= 10
        ); // Regular user

      case "active_user_multiple_goals":
        return (
          this.userState.userJourney.hasCreatedGoal &&
          this.userState.totalVisits >= 15
        ); // Very active user
      ...
      case "course_completed":
        ...
        const courseIdMatch = this.currentRoute.match(
          /\/dashboard\/learning\/([^\/]+)$/,
        );
        ...
        return (
          ...
          this.userState.routeVisits[this.currentRoute] <= 2
        ); // Don't show too often on same course
  ...
  ): GuidanceScenario | null {
    // Sort by priority (high > medium > low) then by frequency settings
    const priorityOrder = { high: 3, medium: 2, low: 1 };
    const frequencyMultiplier =
      this.userState.preferences.frequencyLevel === "high"
        ? 1
        : this.userState.preferences.frequencyLevel === "medium"
          ? 0.7
          : 0.4;
  ...
  private shouldShowScenario(scenario: GuidanceScenario): boolean {
    ...
    if (scenario.cooldownHours) {
      const hoursSinceShown =
        (Date.now() - scenarioState.lastShown) / (1000 * 60 * 60);
  ...
  private saveUserState() {
    ...
    try {
      localStorage.setItem(
        "dashboard-guidance-state",
        JSON.stringify(this.userState),
      );
    } catch (error) {
...
let dashboardGuidanceMonitorInstance: DashboardGuidanceMonitor | null = null;

function getDashboardGuidanceMonitorInstance() {
  if (!dashboardGuidanceMonitorInstance) {
    dashboardGuidanceMonitorInstance = DashboardGuidanceMonitor.getInstance();
  }

  return dashboardGuidanceMonitorInstance;
}

export const dashboardGuidanceMonitor = {
  initialize(callbacks: {
    onShowTooltip: (
      agentId: AI_ID,
      message: string,
    ...
    getDashboardGuidanceMonitorInstance().initialize(callbacks);
  },
  trackRouteChange(route: string, params: Record<string, string> = {}) {
    getDashboardGuidanceMonitorInstance().trackRouteChange(route, params);
  },
  trackUserAction(action: string, data?: any) {
    getDashboardGuidanceMonitorInstance().trackUserAction(action, data);
  },
  setTrialEligibility(isEligible: boolean) {
    getDashboardGuidanceMonitorInstance().setTrialEligibility(isEligible);
  },
  updatePreferences(preferences: Partial<UserGuidanceState["preferences"]>) {
    getDashboardGuidanceMonitorInstance().updatePreferences(preferences);
  },
  hideGuidance(agentId: AI_ID) {
    getDashboardGuidanceMonitorInstance().hideGuidance(agentId);
  },
  resetGuidanceState() {
    getDashboardGuidanceMonitorInstance().resetGuidanceState();
  },
  getGuidanceStats() {
    return getDashboardGuidanceMonitorInstance().getGuidanceStats();
  },
  destroy() {
    dashboardGuidanceMonitorInstance?.destroy();
    dashboardGuidanceMonitorInstance = null;
  },
};
