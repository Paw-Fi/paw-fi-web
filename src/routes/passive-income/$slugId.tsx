...
export const Route = createFileRoute("/passive-income/$slugId")({
  ...
  head: ({ params }) => {
    ...
    const variant =
      passiveIncomeVariants[variantKey] ||
      passiveIncomeVariants["high-interest-portfolios"];
      ...
      "@graph": [
        {
          ...
          description:
            "AI-powered financial education and passive income platform with expert-backed curriculum",
          url: "https://moneko.io",
          logo: {
            "@type": "ImageObject",
        ...
        },
        {
          ...
          description:
            "Comprehensive financial education platform specializing in passive income, high-interest portfolios, and AI-powered learning",
          url: "https://moneko.io",
          inLanguage: "en-US",
          publisher: {
            "@type": "Organization",
          ...
          about: [
            {
              ...
              description:
                "Comprehensive education on building sustainable passive income streams",
            },
            {
              "@type": "Thing",
              name: "Financial Independence",
              description:
                "Strategies and tools for achieving financial independence through passive income",
            },
          ],
        },
        {
          ...
          about: [
            {
              ...
              description:
                "High-interest investment portfolios designed for passive income generation",
            ...
            },
            {
              ...
              description:
                "Mathematical principle where earnings generate additional earnings over time",
            },
            {
              "@type": "Thing",
              name: "Financial Independence Retire Early (FIRE)",
              description:
                "Movement focused on extreme saving and investing to achieve early retirement",
            },
          ],
          mainEntity: {
            "@type": "Service",
            ...
            description:
              "Personalized passive income portfolio construction with AI optimization and expert guidance",
            provider: {
              "@type": "Organization",
              "@id": "https://moneko.io#organization",
            },
            ...
            offers: {
              ...
              description:
                "Free passive income education and AI-powered portfolio recommendations",
            },
            hasOfferCatalog: {
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    ...
                    description:
                      "AI-powered tool for creating passive income portfolios",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description:
                      "Advanced calculator for compound interest projections",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description:
                      "Tools for FIRE movement and early retirement planning",
                  },
                },
              ],
            },
        ...
        },
        {
          ...
          description:
            "Step-by-step guide to building sustainable passive income through high-interest portfolios",
          image: "https://moneko.io/og-img.png",
          totalTime: "PT30M",
          estimatedCost: {
            "@type": "MonetaryAmount",
