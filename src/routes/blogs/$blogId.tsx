...
function BlogDetailPage() {
  ...
  return (
    <div className="w-full h-full bg-moneko-background">
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4 border-b border-border pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{blog.author.title}</p>
            </div>
          </div>
        ...
        <div className="relative mb-10 aspect-video w-full overflow-hidden rounded-2xl">
          ...
          />
          <a href={blog.coverImage} target="_blank" rel="noopener noreferrer" className="absolute bottom-2 right-2 rounded-sm bg-background/80 backdrop-blur-sm px-2 py-1 text-xs text-muted-foreground border border-border">
            Image from Unsplash
          </a>
        </div>
            ...
            {relatedBlogs.map((relatedBlog, index) => (
              ...
              >
                <Link
                  ...
                  resetScroll={true}
                  className="group block h-full overflow-hidden rounded-xl bg-card shadow-md transition-all hover:shadow-lg"
                >
