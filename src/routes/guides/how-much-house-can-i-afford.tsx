...
export const Route = createFileRoute("/guides/how-much-house-can-i-afford")({
  ...
  head: () => {
    ...
    const description =
      "Calculate exactly how much house you can afford with your salary. Use the 28/36 rule, debt-to-income ratios, and current market rates.";
    const keywords =
      "how much house can I afford, home affordability calculator, house affordability, mortgage affordability, home buying budget";
...
function HouseAffordabilityGuide() {
  ...
  const calculateAffordability = () => {
    ...
    if (income > 0) {
      ...
      const recommendedHomePrice = Math.min(
        maxHomePrice,
        incomeMultiplierPrice,
      );
      ...
      return {
        ...
        remainingMonthlyBudget:
          monthlyIncome - availableForHousing - debts - expenses,
      };
    }
    return null;
  };
  ...
  const getAffordabilityCategory = (homePrice: number, income: number) => {
    ...
    if (ratio <= 3)
      return {
        category: "Conservative Range",
        color: "text-green-600 dark:text-green-400",
        description: "Very affordable with room for other goals",
      };
    if (ratio <= 4)
      return {
        category: "Moderate Range",
        color: "text-blue-600 dark:text-blue-400",
        description: "Comfortable affordability",
      };
    if (ratio <= 5)
      return {
        category: "Aggressive Range",
        color: "text-yellow-600 dark:text-yellow-400",
        description: "At upper limit of affordability",
      };
    return {
      category: "Overextended",
      color: "text-red-600 dark:text-red-400",
      description: "Consider a lower price range",
    };
  };
    ...
    <AmbientHaloLayout>
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "Complete guide to determining your home buying budget using the 28/36 rule, debt-to-income ratios, and down payment considerations.",
          totalTime: "PT15M",
          estimatedCost: {
            currency: "USD",
            value: "0",
        ...
        data={[
          {
            ...
            answer:
              "Generally, you can afford a house that costs 3-5 times your annual salary, depending on your debts and down payment. Use the 28/36 rule: spend no more than 28% of gross monthly income on housing and 36% on total debt payments.",
          },
          {
            question: "What is the 28/36 rule for home affordability?",
            answer:
              "The 28/36 rule says housing costs shouldn't exceed 28% of gross monthly income, and total debt payments shouldn't exceed 36%. For example, with $75,000 annual income ($6,250 monthly), housing should be under $1,750 and total debts under $2,250.",
          },
          {
            question: "How much down payment do I need to afford a house?",
            answer:
              "Down payments range from 0% (VA loans) to 20% (conventional without PMI). FHA loans require 3.5%, conventional loans start at 3%. Higher down payments reduce monthly costs but require more upfront cash.",
          },
          {
            question:
              "Should I use 3x or 5x my income to determine affordability?",
            answer:
              "Use 3x income for conservative affordability with room for other financial goals. Use up to 5x income if you have minimal debt, excellent credit, and stable income. Consider your complete financial picture, not just income multiples.",
          },
          {
            question: "What if I have student loans or credit card debt?",
            answer:
              "Existing debt reduces how much house you can afford. Lenders count minimum monthly debt payments against your 36% total debt ratio. Pay down high-interest debt before buying to increase your home buying power.",
          },
          {
            question: "How much should I save for closing costs?",
            answer:
              "Budget 2-5% of home price for closing costs. On a $300,000 home, expect $6,000-15,000 in closing costs including loan origination, title insurance, appraisal, inspection, and prepaid taxes and insurance.",
          },
          {
            question: "Can I afford a house if I'm self-employed?",
            answer:
              "Self-employed buyers can qualify but need 2 years of tax returns and consistent income documentation. Lenders may average your income over 2 years, so stable earnings history is crucial for determining affordability.",
          },
          {
            question: "What other costs should I consider beyond the mortgage?",
            answer:
              "Budget for property taxes (1-2% annually), homeowner's insurance ($1,200+ annually), maintenance (1-3% of home value annually), utilities, and potential HOA fees. These add $300-800+ monthly to your housing costs.",
          },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-4 md:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-6 text-center text-lg text-gray-700 dark:text-gray-300">
            Calculate your true home buying budget using proven affordability
            rules and current market conditions.
          </p>
          ...
          <div className="mb-8 border-t border-b border-gray-200 py-4 text-center text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
            ...
            <p>
              <strong>Data Sources:</strong> Federal Housing Administration
              Guidelines, Consumer Financial Protection Bureau, National
          ...
          <div className="mb-12 rounded-xl border border-gray-200 bg-white/50 p-6 backdrop-blur-sm dark:border-gray-700 dark:bg-slate-900/50">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="space-y-4">
                <div>
                  <label className="text-foreground dark:text-dark-foreground mb-2 block text-sm font-medium">
                    Annual Gross Income ($)
                  </label>
                  <input
                    type="number"
                    ...
                    className="text-foreground dark:text-dark-foreground w-full rounded-lg border border-gray-300 bg-white p-3 dark:border-gray-600 dark:bg-gray-800"
                    placeholder="75000"
                  />
            ...
            {calculation && (
              <div className="mt-8 grid gap-6 lg:grid-cols-3">
                <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
                  <h3 className="mb-3 font-semibold text-blue-800 dark:text-blue-300">
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">
                        ${calculation.maxHousingPayment.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">
                        {(
                          calculation.maxHomePrice / parseFloat(annualIncome)
                        ).toFixed(1)}
                        x
                      </span>
                    </div>
                ...
                <div className="rounded-lg bg-green-50 p-4 dark:bg-green-900/20">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">
                        ${calculation.downPaymentNeeded.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Closing costs (est.):</span>
                      <span className="font-semibold">
                        ${calculation.closingCosts.toLocaleString()}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between text-base font-bold">
                      ...
                      <span className="text-green-600 dark:text-green-400">
                        ${calculation.totalUpfrontCosts.toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg bg-purple-50 p-4 dark:bg-purple-900/20">
                  <h3 className="mb-3 font-semibold text-purple-800 dark:text-purple-300">
                    Budget Assessment
                  </h3>
                  <div className="space-y-3">
                    <div
                      className={`text-center ${getAffordabilityCategory(calculation.maxHomePrice, parseFloat(annualIncome)).color}`}
                    >
                      <div className="font-semibold">
                        {
                          getAffordabilityCategory(
                            calculation.maxHomePrice,
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-500">
                        For savings, emergencies, and lifestyle
                      </p>
                    </div>
                  </div>
                </div>
              ...
              items={[
                {
                  ...
                  details:
                    "Generally need 25-33% of home price as annual income. Higher for expensive areas, lower with minimal debt.",
                },
                {
                  category: "Down Payment Options",
                  details:
                    "VA: 0%, USDA: 0%, FHA: 3.5%, Conventional: 3-20%. Higher down = lower monthly payment.",
                },
                {
                  category: "Monthly Budget Breakdown",
                  details:
                    "Principal & Interest (~75%), Property Taxes (~15%), Insurance (~7%), PMI if <20% down (~3%)",
                },
                {
                  category: "Additional Costs",
                  details:
                    "Moving expenses, immediate repairs, furniture, utility setup, maintenance fund (1% of home value annually)",
                },
                {
                  category: "Timing Considerations",
                  details:
                    "Buy when: stable job, 5+ year timeline, emergency fund intact, debt manageable, down payment saved",
                },
              ]}
            />
          ...
          <div className="mt-12 rounded-xl bg-gradient-to-r from-blue-500 to-green-500 p-6 text-center text-white">
            ...
            <p className="mb-6">
              Now that you know how much house you can afford, calculate your
              exact monthly payments and compare loan options.
            </p>
