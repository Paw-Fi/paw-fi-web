...
export const Route = createFileRoute("/guides/how-to-calculate-net-worth")({
  ...
  head: () => {
    ...
    const title =
      "How to Calculate Net Worth | Complete Guide with Examples | Moneko";
    const description =
      "Learn how to calculate your net worth step-by-step. Understand what counts as assets and liabilities, and track your financial progress over time.";
    const keywords =
      "net worth calculator, how to calculate net worth, assets minus liabilities, personal finance net worth, wealth calculation";
  ...
  const getNetWorthCategory = (netWorth: number) => {
    if (netWorth >= 1000000)
      return {
        ...
        description: "$1M+ - Excellent financial position",
      };
    if (netWorth >= 100000)
      return {
        category: "Strong Position",
        color: "text-blue-600 dark:text-blue-400",
        description: "Building substantial wealth",
      };
    if (netWorth >= 0)
      return {
        category: "Positive Net Worth",
        color: "text-purple-600 dark:text-purple-400",
        description: "Assets exceed debts - good foundation",
      };
    return {
      category: "Negative Net Worth",
      color: "text-red-600 dark:text-red-400",
      description: "Focus on debt reduction and asset building",
    };
  };
    ...
    <AmbientHaloLayout>
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "Complete guide to calculating net worth by listing assets, liabilities, and understanding what counts in each category.",
          totalTime: "PT15M",
          estimatedCost: {
            currency: "USD",
            value: "0",
        ...
        data={[
          {
            ...
            answer:
              "Net worth is the difference between what you own (assets) and what you owe (liabilities). It's the best single measure of your overall financial health and wealth-building progress.",
          },
          {
            question: "What counts as assets in net worth calculation?",
            answer:
              "Assets include cash, savings accounts, investments, retirement accounts, real estate, vehicles, jewelry, art, and other valuable items you could sell for money.",
          },
          {
            question: "Should I include my home in net worth calculation?",
            answer:
              "Yes, include your home's current market value as an asset, and include any remaining mortgage balance as a liability. Use recent comparable sales or online estimates for valuation.",
          },
          {
            question: "What is a good net worth for my age?",
            answer:
              "A common rule of thumb is that your net worth should equal your age times your annual income divided by 10. For example, a 30-year-old earning $50,000 should aim for a net worth of $150,000.",
          },
          {
            question: "How often should I calculate my net worth?",
            answer:
              "Calculate your net worth monthly or quarterly to track progress. Annual calculations are minimum for monitoring long-term wealth building and financial goal achievement.",
          },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-4 md:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-6 text-center text-lg text-gray-700 dark:text-gray-300">
            Master the fundamental calculation that shows your true financial
            position and wealth-building progress.
          </p>
          ...
          <div className="mb-8 border-t border-b border-gray-200 py-4 text-center text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
            ...
            <p>
              <strong>Data Sources:</strong> Federal Reserve Survey of Consumer
              Finances, FDIC National Survey, Financial Planning Standards
            </p>
          </div>
          ...
          <div className="mb-12 rounded-xl border border-gray-200 bg-white/50 p-6 backdrop-blur-sm dark:border-gray-700 dark:bg-slate-900/50">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-foreground dark:text-dark-foreground mb-1 block text-sm font-medium">
                      Cash & Savings ($)
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={(e) =>
                        setAssets({ ...assets, cashSavings: e.target.value })
                      }
                      className="text-foreground dark:text-dark-foreground w-full rounded border border-gray-300 bg-white p-2 text-sm dark:border-gray-600 dark:bg-gray-800"
                      placeholder="25,000"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setAssets({ ...assets, investments: e.target.value })
                      }
                      className="text-foreground dark:text-dark-foreground w-full rounded border border-gray-300 bg-white p-2 text-sm dark:border-gray-600 dark:bg-gray-800"
                      placeholder="50,000"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setAssets({ ...assets, retirement: e.target.value })
                      }
                      className="text-foreground dark:text-dark-foreground w-full rounded border border-gray-300 bg-white p-2 text-sm dark:border-gray-600 dark:bg-gray-800"
                      placeholder="75,000"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setAssets({ ...assets, realEstate: e.target.value })
                      }
                      className="text-foreground dark:text-dark-foreground w-full rounded border border-gray-300 bg-white p-2 text-sm dark:border-gray-600 dark:bg-gray-800"
                      placeholder="300,000"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setAssets({ ...assets, vehicle: e.target.value })
                      }
                      className="text-foreground dark:text-dark-foreground w-full rounded border border-gray-300 bg-white p-2 text-sm dark:border-gray-600 dark:bg-gray-800"
                      placeholder="15,000"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={assets.other}
                      onChange={(e) =>
                        setAssets({ ...assets, other: e.target.value })
                      }
                      className="text-foreground dark:text-dark-foreground w-full rounded border border-gray-300 bg-white p-2 text-sm dark:border-gray-600 dark:bg-gray-800"
                      placeholder="10,000"
                    />
            ...
            {/* Net Worth Result */}
            <div className="mt-8 rounded-xl border bg-gray-50 p-6 dark:bg-gray-800">
              <div className="text-center">
                <div className="text-primary dark:text-dark-primary mb-2 text-4xl font-bold">
                  ${netWorth.toLocaleString()}
                </div>
                <div className="text-foreground dark:text-dark-foreground mb-2 text-xl font-semibold">
                  Your Net Worth
                </div>
                {netWorth !== 0 && (
                  <div>
                    <div
                      className={`mb-2 text-lg font-semibold ${getNetWorthCategory(netWorth).color}`}
                    >
              ...
              items={[
                {
                  ...
                  details:
                    "Your total wealth - the difference between what you own and what you owe",
                },
                {
                  category: "Key Assets to Include",
                  details:
                    "Cash, savings, investments, retirement accounts, real estate, vehicles, valuable items",
                },
                {
                  category: "Key Liabilities to Include",
                  details:
                    "All debts - mortgages, credit cards, student loans, auto loans, personal loans",
                },
                {
                  category: "Improvement Strategy",
                  details:
                    "Increase savings and investments, pay down high-interest debt, build equity in assets",
                },
                {
                  category: "Tracking Frequency",
                  details:
                    "Monthly or quarterly monitoring to see progress and adjust financial strategy",
                },
              ]}
            />
          ...
          {/* Call to Action */}
          <div className="mt-12 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 p-6 text-center text-white">
            <h2 className="mb-4 text-2xl font-bold">
              Ready to Build Your Wealth?
            </h2>
            <p className="mb-6">
              Use our financial calculators to create a plan for growing your
              net worth over time.
            </p>
