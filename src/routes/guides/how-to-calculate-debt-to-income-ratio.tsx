...
export const Route = createFileRoute(
  ...
  head: () => {
    ...
    const title =
      "How to Calculate Debt-to-Income Ratio | Step-by-Step Guide | Moneko";
    const description =
      "Learn how to calculate your debt-to-income ratio (DTI) with our step-by-step guide. Understand what lenders look for and how to improve your DTI for loan approval.";
    const keywords =
      "debt to income ratio, DTI calculator, how to calculate DTI, debt income ratio formula, loan approval requirements";
  ...
  const getDTICategory = (ratio: number) => {
    if (ratio <= 36)
      return {
        ...
        description: "Most lenders prefer this range",
      };
    if (ratio <= 43)
      return {
        category: "Good",
        color: "text-yellow-600 dark:text-yellow-400",
        description: "Generally acceptable for most loans",
      };
    if (ratio <= 50)
      return {
        category: "Fair",
        color: "text-orange-600 dark:text-orange-400",
        description: "May limit loan options",
      };
    return {
      category: "High Risk",
      color: "text-red-600 dark:text-red-400",
      description: "Difficult to qualify for new credit",
    };
  };
    ...
    <AmbientHaloLayout>
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "Step-by-step guide to calculating your debt-to-income ratio to understand your financial health and loan eligibility.",
          totalTime: "PT10M",
          estimatedCost: {
            currency: "USD",
            value: "0",
        ...
        data={[
          {
            ...
            answer:
              "Most lenders prefer a debt-to-income ratio of 36% or lower. A ratio between 37-43% is generally acceptable for most loans, while anything above 43% may limit your borrowing options and indicate financial strain.",
          },
          {
            question: "What counts as debt in DTI calculation?",
            answer:
              "Include all minimum monthly debt payments: credit cards, student loans, auto loans, mortgages, personal loans, and other recurring debt obligations. Do not include utilities, insurance, or groceries.",
          },
          {
            question: "Should I use gross or net income for DTI?",
            answer:
              "Always use gross monthly income (before taxes) when calculating debt-to-income ratio. This is what lenders use to assess your borrowing capacity.",
          },
          {
            question: "How can I improve my debt-to-income ratio?",
            answer:
              "You can improve DTI by increasing income through raises or side jobs, paying down existing debts faster, or avoiding new debt. Focus on high-interest debt first for maximum impact.",
          },
          {
            question: "What DTI ratio do I need for a mortgage?",
            answer:
              "For conventional mortgages, most lenders prefer DTI ratios of 43% or lower, though some may accept up to 45%. FHA loans may allow higher ratios with compensating factors.",
          },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-4 md:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-6 text-center text-lg text-gray-700 dark:text-gray-300">
            Learn the step-by-step process to calculate your DTI ratio and
          ...
          <div className="mb-8 border-t border-b border-gray-200 py-4 text-center text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
            ...
            <p>
              <strong>Data Sources:</strong> Consumer Financial Protection
              Bureau, Fannie Mae Guidelines, Freddie Mac Standards
            </p>
          </div>
            ...
            {dtiRatio && (
              <div className="mt-6 rounded-lg border bg-gray-50 p-4 dark:bg-gray-800">
                <div className="text-center">
                  <div className="text-primary dark:text-dark-primary mb-2 text-3xl font-bold">
                    {dtiRatio}%
                  </div>
                  <div
                    className={`mb-2 text-lg font-semibold ${getDTICategory(parseFloat(dtiRatio)).color}`}
                  >
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border border-gray-200 p-6 dark:border-gray-700">
                ...
                <p className="mt-3 text-sm text-yellow-600 dark:text-yellow-400">
                  <strong>Note:</strong> Don't include utilities, insurance,
              ...
              <div className="rounded-xl border border-gray-200 p-6 dark:border-gray-700">
                ...
                <div className="mb-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Example: If you earn $5,000/month and have $1,500 in debt
                  payments:
                  <br />
              ...
              items={[
                {
                  ...
                  details:
                    "Your monthly debt burden relative to income - a key indicator of financial health",
                },
                {
                  category: "Income to Use",
                  details:
                    "Gross monthly income (before taxes) including all regular income sources",
                },
                {
                  category: "Debts to Include",
                  details:
                    "All minimum monthly debt payments - credit cards, loans, mortgages",
                },
                {
                  category: "Improvement Strategy",
                  details:
                    "Increase income, pay down high-interest debt, avoid new debt obligations",
                },
                {
                  category: "Lender Preferences",
                  details:
                    "36% or lower preferred, up to 43% acceptable, above 43% limits options",
                },
              ]}
            />
          ...
          <div className="mt-12 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 p-6 text-center text-white">
            ...
            <p className="mb-6">
              Use our comprehensive calculators to create a debt payoff plan and
