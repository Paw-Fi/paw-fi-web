...
export const Route = createFileRoute(
  ...
  head: () => {
    ...
    const description =
      "Use our interactive decision tree to determine whether to pay off debt or build savings first. Expert guidance for credit cards and emergency funds.";
    const keywords =
      "pay off debt or save first, debt vs savings, emergency fund vs debt, financial priority decision tree, debt payoff strategy";
...
function DebtVsSavingsGuide() {
  ...
  const decisionTree = {
    start: {
      ...
      options: [
        ...
        {
          answer: "Have 3+ months of expenses saved",
          next: "has_full_emergency",
        },
      ],
    },
    no_emergency: {
      ...
      options: [
        {
          answer: "High-interest debt (credit cards 20%+)",
          next: "high_interest_no_emergency",
        },
        {
          answer: "Medium-interest debt (10-19%)",
          next: "medium_interest_no_emergency",
        },
        {
          answer: "Low-interest debt (under 10%)",
          next: "low_interest_no_emergency",
        },
      ],
    },
    has_some_emergency: {
    ...
    has_full_emergency: {
      ...
      options: [
        ...
        {
          answer: "10-19% (personal loans)",
          next: "medium_interest_good_emergency",
        },
        {
          answer: "Under 10% (student loans, mortgage)",
          next: "low_interest_good_emergency",
        },
      ],
    },
  };
  ...
  const recommendations = {
    high_interest_no_emergency: {
      ...
      explanation:
        "With no emergency fund and high-interest debt, you're in a precarious position. Build a small emergency fund ($500-1000) first, then attack the high-interest debt aggressively.",
      action_plan: [
      ...
      reasoning:
        "High-interest debt costs you 20%+ annually, but having zero emergency savings forces you to create more debt when emergencies happen.",
    },
    medium_interest_no_emergency: {
      priority: "Emergency Fund First",
      explanation:
        "Build your emergency fund to $1,000 before focusing on medium-interest debt. This prevents you from going further into debt during emergencies.",
      action_plan: [
      ...
      reasoning:
        "Medium-interest debt (10-19%) is costly but not as urgent as having zero financial safety net.",
    },
    low_interest_no_emergency: {
      priority: "Emergency Fund Strongly Prioritized",
      explanation:
        "Low-interest debt can wait. With no emergency savings, you're one car repair away from high-interest debt. Build emergency fund first.",
      action_plan: [
      ...
      reasoning:
        "Low-interest debt (under 10%) costs less than emergency situations typically create in new high-interest debt.",
    },
    high_interest_good_emergency: {
      priority: "Attack High-Interest Debt Aggressively",
      explanation:
        "With a solid emergency fund and high-interest debt, focus all extra money on debt elimination. The guaranteed 20%+ return from debt payoff beats most investments.",
      action_plan: [
      ...
      reasoning:
        "You have financial security with your emergency fund, and 20%+ guaranteed returns from debt payoff exceed expected market returns.",
    },
    medium_interest_good_emergency: {
      priority: "Focus on Debt Payoff",
      explanation:
        "With good emergency savings, focus on eliminating medium-interest debt. The guaranteed return from debt payoff is attractive in current market conditions.",
      action_plan: [
      ...
      reasoning:
        "Medium-interest debt guaranteed return often beats volatile market returns, especially with emergency fund already established.",
    },
    low_interest_good_emergency: {
      priority: "Consider Investing Instead",
      explanation:
        "With low-interest debt and solid emergency savings, investing extra money might provide better long-term returns than debt payoff.",
      action_plan: [
      ...
      reasoning:
        "Low-interest debt (under 10%) combined with solid emergency fund puts you in position to optimize for growth rather than debt elimination.",
    },
  };
    ...
    <AmbientHaloLayout>
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "Step-by-step decision tree to determine your optimal financial strategy based on emergency fund status, debt interest rates, and risk tolerance.",
          totalTime: "PT15M",
          estimatedCost: {
            currency: "USD",
            value: "0",
        ...
        data={[
          {
            ...
            answer:
              "It depends on your emergency fund status and debt interest rates. If you have no emergency fund and high-interest debt (20%+), build a $500-1000 mini emergency fund first, then attack the debt. If you have some emergency savings, focus on high-interest debt first.",
          },
          {
            question: "What if I have credit card debt but no emergency fund?",
            answer:
              "Build a small emergency fund ($500-1000) first to prevent creating more debt during emergencies, then aggressively pay off credit cards. Without an emergency fund, you'll likely end up in more debt when unexpected expenses arise.",
          },
          {
            question: "Should I invest or pay off student loans?",
            answer:
              "If student loan rates are under 7% and you have a solid emergency fund, investing may provide better returns. Consider tax implications - student loan interest may be tax-deductible. For rates above 7%, debt payoff typically provides better guaranteed returns.",
          },
          {
            question: "How much should I save in my emergency fund?",
            answer:
              "Aim for 3-6 months of essential expenses. Start with $500-1000 if you have high-interest debt, then build to one month, then gradually to 3-6 months. Self-employed individuals should target 6-12 months due to irregular income.",
          },
          {
            question: "What counts as high-interest debt?",
            answer:
              "Debt with interest rates above 15-20% is typically considered high-interest, including most credit cards, payday loans, and some personal loans. These should be eliminated before focusing on investing or building large emergency funds.",
          },
          {
            question: "Should I stop 401k contributions to pay off debt?",
            answer:
              "Never stop contributing enough to get your full employer match - it's free money with immediate 50-100% returns. For high-interest debt (20%+), consider temporarily reducing contributions beyond the match to accelerate debt payoff.",
          },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-4 md:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-6 text-center text-lg text-gray-700 dark:text-gray-300">
            Use our interactive decision tree to find your optimal financial
            strategy based on your emergency fund and debt situation.
          </p>
          ...
          <div className="mb-8 border-t border-b border-gray-200 py-4 text-center text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
            ...
            <p>
              ...
              <a
                href="https://www.consumerfinance.gov/about-us/blog/building-emergency-savings/"
                target="_blank"
              ...
              ,{" "}
              <a
                href="https://www.ramseysolutions.com/debt/debt-snowball-vs-debt-avalanche"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:underline dark:text-blue-400"
              >
              ...
              ,{" "}
              <a
                href="https://www.investopedia.com/articles/personal-finance/040715/when-pay-debt-vs-invest.asp"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:underline dark:text-blue-400"
              >
                Investopedia Debt vs Investment Analysis
              </a>
            </p>
          </div>

          {/* Interactive Decision Tree */}
          <div className="mb-12 rounded-xl border border-gray-200 bg-white/50 p-6 backdrop-blur-sm dark:border-gray-700 dark:bg-slate-900/50">
            ...
            {currentQuestion ? (
                  ...
                  <div className="space-y-3">
                    {currentQuestion.options.map((option, index) => (
                      <button
                        ...
                        className="w-full rounded-lg border border-gray-300 bg-white p-3 text-left transition-colors hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:hover:bg-gray-700"
                      >
                        {option.answer}
                      </button>
                    ))}
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full rounded-lg bg-gray-600 p-3 text-white transition-colors hover:bg-gray-700"
                >
          ...
          <div className="mb-12 rounded-xl border border-gray-200 bg-white/50 p-6 backdrop-blur-sm dark:border-gray-700 dark:bg-slate-900/50">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg bg-yellow-50 p-4 dark:bg-yellow-900/20">
                <h3 className="mb-3 text-lg font-bold text-yellow-800 dark:text-yellow-300">
                  Emergency Fund Priority
                </h3>
                <p className="mb-3 text-sm text-gray-700 dark:text-gray-300">
                  Financial experts agree: some emergency savings is crucial
              ...
              <div className="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
                ...
                <p className="mb-3 text-sm text-gray-700 dark:text-gray-300">
                  Credit card debt averaging 22% APR in 2025 demands urgent
                  attention after basic emergency fund.
                </p>
                <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="mb-12 rounded-xl border border-purple-200 bg-purple-50/50 p-6 backdrop-blur-sm dark:border-purple-700 dark:bg-purple-900/20">
            <h2 className="mb-6 text-center text-2xl font-bold text-purple-800 dark:text-purple-300">
              ...
              items={[
                {
                  ...
                  details:
                    "Build $500-1000 emergency fund regardless of debt situation to prevent debt spiral",
                },
                {
                  category: "Step 2: High-Interest Debt Attack",
                  details:
                    "Pay minimum on everything, attack highest interest debt (usually credit cards) first",
                },
                {
                  category: "Step 3: Build Full Emergency Fund",
                  details:
                    "Once high-interest debt eliminated, build 3-6 month emergency fund",
                },
                {
                  category: "Step 4: Medium Interest Debt vs. Investing",
                  details:
                    "Evaluate 7-15% debt payoff vs. investing based on risk tolerance and time horizon",
                },
                {
                  category: "Step 5: Low Interest Debt Strategy",
                  details:
                    "Pay minimums on sub-7% debt while maximizing investments and retirement contributions",
                },
              ]}
            />
          ...
          {/* Call to Action */}
          <div className="mt-12 rounded-xl bg-gradient-to-r from-blue-500 to-green-500 p-6 text-center text-white">
            <h2 className="mb-4 text-2xl font-bold">
              Ready to Implement Your Strategy?
            </h2>
            <p className="mb-6">
              Use our financial calculators to create specific plans for debt
              payoff and emergency fund building.
            </p>
            <div className="space-x-4">
              ...
              <a
                href="/calculators/compound-calculator"
                className="inline-block rounded-lg border border-white bg-blue-600 px-6 py-3 font-semibold text-white transition-colors hover:bg-blue-700"
              >
