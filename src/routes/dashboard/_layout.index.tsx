    ...
    const structuredData = {
      ...
      "@graph": [
        ...
        },
        {
          ...
          operatingSystem: "Any",
          description:
            "Comprehensive personal finance dashboard with AI-powered portfolio tracking, goal management, financial education, and smart calculators",
          url: pageUrl,
          author: {
            "@id": "https://moneko.io/#organization",
          },
          ...
          offers: [
            {
              ...
              description:
                "Free access to basic portfolio tracking and financial calculators",
            },
            {
              "@type": "Offer",
              price: "9.99",
              ...
              description:
                "Full AI coaching, advanced analytics, personalized recommendations, and unlimited access",
              priceSpecification: {
        ...
        },
        {
          ...
          description:
            "Comprehensive personal finance management with AI-powered insights, education, and portfolio tracking",
          provider: {
            "@id": "https://moneko.io/#organization",
          },
          ...
          audience: {
            "@type": "Audience",
            audienceType:
              "Individual Investors, Students, Young Professionals, Families",
          },
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description:
                    "Real-time investment portfolio monitoring and analysis",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  ...
                  description:
                    "Interactive courses and lessons on personal finance topics",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  ...
                  name: "AI Financial Coaching",
                  description:
                    "Personalized financial advice and recommendations powered by AI",
                },
              },
            ],
          },
        },
        {
          ...
          description:
            "Key features available in the Moneko personal finance dashboard",
          itemListElement: [
            {
              "@type": "ListItem",
              position: 1,
              ...
              description:
                "Comprehensive view of income, savings, expenses, and financial health metrics",
            },
            {
              "@type": "ListItem",
              position: 2,
              ...
              description:
                "Track educational progress through financial courses and lessons with XP rewards",
            },
            {
              "@type": "ListItem",
              position: 3,
              name: "AI Assistant",
              description:
                "24/7 AI-powered financial advisor for personalized guidance and support",
            },
            {
              "@type": "ListItem",
              position: 4,
              name: "Quick Tools",
              description:
                "Access to essential financial calculators for planning and analysis",
            },
            {
              "@type": "ListItem",
              position: 5,
              name: "Goal Tracking",
              description:
                "Monitor progress toward financial objectives with visual progress indicators",
            },
          ],
        },
      ],
