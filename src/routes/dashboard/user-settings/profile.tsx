...
export const Route = createFileRoute("/dashboard/user-settings/profile")({
  component: lazyRouteComponent(
    () =>
      import(
        "@/components/performance/financial-profile-settings-route-component"
      ),
    "FinancialProfileSettingsRouteComponent",
  ),
  head: () => {
    const pageUrl = getCanonicalUrl(
      "/dashboard/user-settings/financial-profile",
    );
    const meta = seo({
      title: "Financial Profile Settings - Personal Info | Moneko",
      description:
        "Update financial information & preferences for personalized AI recommendations and financial planning.",
