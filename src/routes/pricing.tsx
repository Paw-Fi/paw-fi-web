 ...
 * - Yearly paid upfront + MONEKO100: /checkout?plan=plus&billing=yearly&promo=MONEKO100
...
export const Route = createFileRoute("/pricing")({
  ...
  head: () => {
    ...
    const meta = seo({
      ...
      description:
        "Moneko Plus includes flexible monthly billing, a discounted yearly plan paid upfront, and lifetime access options for AI expense capture, reports, scenarios, wallets, Spaces, bank sync, and multi-currency tools.",
      keywords:
