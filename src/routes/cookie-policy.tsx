...
export const Route = createFileRoute("/cookie-policy")({
  ...
  head: () => {
    ...
    const meta = seo({
      ...
      description:
        "Learn about how Moneko uses cookies and similar technologies on our website to enhance your browsing experience.",
    ...
    const structuredData = {
      ...
      name: "Cookie Policy",
      description:
        "Moneko's cookie policy explaining how we use cookies and similar technologies",
      url: pageUrl,
      publisher: {
        "@type": "Organization",
        name: "Moneko",
    ...
    <div className="flex-1 bg-white px-6 py-12 md:px-12 lg:px-24">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="prose max-w-none">
          ...
          <p>Moneko uses cookies for several purposes, including:</p>
          ...
          <p>
            These are temporary cookies that are erased when you close your
          ...
          <p>
            These remain on your device after you close your browser. They help
            our website recognize you as a returning visitor and remember your
            preferences.
          </p>
          ...
          <p>
            These are set by third-party services we use, such as analytics
            providers.
          </p>
          ...
          <p>
            ...
            "Preferences," or "Settings" menu of your browser. You can:
          </p>
          <ul className="list-disc pl-8">
          ...
          <p>
            ...
            be posted on this page, and if the changes are significant, we will
