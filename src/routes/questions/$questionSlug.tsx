      ...
      "@graph": [
        {
          ...
          description:
            "AI-powered financial education platform with expert-backed curriculum and personalized guidance",
          url: "https://moneko.io",
          logo: {
            "@type": "ImageObject",
        ...
        },
        {
          ...
          description:
            "Comprehensive financial education platform specializing in personal finance questions, AI-powered learning, and expert guidance",
          url: "https://moneko.io",
          inLanguage: "en-US",
          publisher: {
            "@type": "Organization",
          ...
          about: [
            {
              ...
              description:
                "Comprehensive financial planning, budgeting, investing, and wealth building guidance",
            },
            {
              "@type": "Thing",
              name: categoryName,
          ...
          mentions: [
            {
              ...
              description:
                "Personalized financial guidance powered by artificial intelligence",
            ...
            },
            {
              ...
              description:
                "Comprehensive financial literacy and education services",
            },
          ],
          speakable: {
        ...
        },
        {
          ...
          about: [
            ...
            },
            {
              ...
              description:
                "Machine learning powered personal finance guidance and education",
            },
          ],
          mainEntity: {
            "@type": "Question",
        ...
        },
        {
          ...
          offers: {
            ...
            description:
              "Free AI-powered financial guidance with immediate access to personalized recommendations",
            itemCondition: "https://schema.org/NewCondition",
          },
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "Financial Guidance Services",
            itemListElement: questionData.content.benefits.map(
              (benefit, index) => ({
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
