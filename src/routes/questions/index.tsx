      ...
      "@graph": [
        {
          ...
          description:
            "AI-powered financial education platform with comprehensive question database and expert guidance",
          url: "https://moneko.io",
          logo: {
            "@type": "ImageObject",
        ...
        },
        {
          ...
          description:
            "Complete collection of financial questions with AI-powered answers covering debt, investing, budgeting, and wealth building",
          url: canonicalUrl,
          inLanguage: "en-US",
          isPartOf: {
            "@type": "WebSite",
          ...
          about: [
            {
              ...
              description:
                "Comprehensive financial literacy and education resources",
            },
            {
              "@type": "Thing",
              name: "AI Financial Assistance",
              description:
                "Artificial intelligence powered financial guidance and support",
            },
          ],
          mainEntity: {
            "@type": "ItemList",
            ...
            description:
              "Organized collection of financial questions across major personal finance topics",
            numberOfItems: Object.values(financialQuestionsData).reduce(
              (total, category) =>
                total + Object.keys(category.questions).length,
              0,
            ),
            itemListElement: Object.entries(financialQuestionsData).map(
        ...
        },
        {
          ...
          description:
            "Comprehensive AI-powered personal finance education platform with expert question database",
          url: "https://moneko.io",
          inLanguage: "en-US",
          publisher: {
            "@type": "Organization",
          ...
          potentialAction: [
            {
              ...
              target: {
                "@type": "EntryPoint",
                urlTemplate:
                  "https://moneko.io/questions?q={search_term_string}",
              },
        ...
        },
        {
          ...
          description:
            "Comprehensive database of personal finance questions with expert AI-powered answers and guidance",
          provider: {
            "@type": "Organization",
            "@id": "https://moneko.io#organization",
          },
          ...
          offers: {
            ...
            description:
              "Free access to comprehensive financial questions database with AI-powered guidance",
          },
        },
      ],
    };
