  ...
  return (
    ...
    >
      ...
      <Link 
        ...
        className="absolute top-4 left-4 flex items-center text-sm text-gray-500 hover:text-gray-800"
      >
        <svg 
          width="16" 
          height="16" 
      ...
      <div className="max-w-4xl w-full mx-auto px-4 py-12">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-purple-100 rounded-xl p-6 feature-card">
          ...
          <div className="bg-green-100 rounded-xl p-6 feature-card">
            <div className="bg-white rounded-full w-12 h-12 flex items-center justify-center mb-3">
          ...
          {/* Learn Your Way card */}
          <div className="bg-blue-100 rounded-xl p-6 feature-card">
            <div className="bg-white rounded-full w-12 h-12 flex items-center justify-center mb-3">
          ...
          <div className="bg-yellow-100 rounded-xl p-6 feature-card">
            <div className="bg-white rounded-full w-12 h-12 flex items-center justify-center mb-3">
