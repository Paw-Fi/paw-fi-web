...
} from "@/components/seo/financial-data-tables";
import {
  RelatedResources,
...
export const Route = createFileRoute("/calculators/mortgage-calculator")({
  ...
  head: () => {
    ...
    const meta = seo({
      ...
      description:
        "Calculate monthly mortgage payments with free home loan calculator. Get PITI estimates, amortization schedules & loan comparisons.",
      keywords:
        "mortgage calculator, home loan calculator, mortgage payment calculator, amortization schedule, PITI calculator, home affordability calculator, mortgage rates, loan calculator",
    ...
    <AmbientHaloLayout>
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "Step-by-step guide to calculate your monthly mortgage payments including principal, interest, taxes, and insurance (PITI) for home buying planning.",
          totalTime: "PT10M",
          estimatedCost: {
            currency: "USD",
            value: "0",
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "Comprehensive mortgage calculator with PITI breakdown and amortization schedule. Calculate monthly payments, total interest, and plan your home purchase budget.",
      ...
      <div className="container mx-auto px-4 py-4 md:px-8 lg:px-12">
        ...
        <p className="mb-6 text-center text-lg text-gray-700 dark:text-gray-300">
          Calculate your monthly mortgage payments (PITI - principal, interest,
          taxes, and insurance) and discover how much house you can afford with
        ...
        <div className="mb-8 border-t border-b border-gray-200 py-4 text-center text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
          ...
          <p>
            <strong>Data Sources:</strong> Freddie Mac Primary Mortgage Market
            Survey, MBA Mortgage Applications Survey, Current Market Rates
          </p>
        </div>
          ...
          <AtAGlance
            ...
            items={[
              ...
              },
              {
                ...
                details:
                  "2-5% of home price (lender fees, title, inspection, taxes)",
              },
              {
                category: "Pre-approval Benefits",
                details:
                  "Know your budget, faster offers, stronger negotiating position",
              },
              {
                category: "Rate Lock Period",
                details:
                  "30-60 days typical, protects against rate increases during purchase",
              },
            ]}
          />
        </div>
        ...
        <StructuredData
          ...
          data={[
            // Core Mortgage Questions
            {
              ...
              answer:
                "Generally, you can afford a house that costs 2.5 to 3 times your annual salary. Use the 28/36 rule: spend no more than 28% of gross monthly income on housing costs and 36% on total debts. For example, with a $75,000 salary, you could afford roughly $1,750 monthly for housing costs.",
            },
            {
              question: "What will my monthly mortgage payment be?",
              answer:
                "Your monthly mortgage payment (called PITI) includes principal, interest, taxes, and insurance. For a $300,000 home with 20% down at 6.5% interest, expect roughly $1,517 monthly for principal and interest, plus taxes and insurance which vary by location.",
            },
            {
              question: "Should I get a 15-year or 30-year mortgage?",
              answer:
                "30-year mortgages have lower monthly payments but cost more in total interest. 15-year mortgages have higher monthly payments but save tens of thousands in interest. Choose 30-year if you need lower payments, 15-year if you want to save money long-term and build equity faster.",
            },
            {
              question: "How much should I put down when buying a house?",
              answer:
                "While 20% down eliminates PMI (private mortgage insurance), you can buy with as little as 3% down. FHA loans require 3.5%, VA loans offer 0% for veterans, and conventional loans start at 3%. Larger down payments reduce monthly costs but tie up more cash.",
            },
            ...
            // Affordability and Budget Questions
            {
              ...
              answer:
                "To afford a $400,000 house, you typically need $80,000 annual income (using 5x income rule), at least $12,000-16,000 for down payment (3-4%), and $8,000-16,000 for closing costs. Your total monthly debts should be under 36% of gross income.",
            },
            {
              question: "What if I can't afford 20% down?",
              answer:
                "You can still buy a home with less than 20% down. You'll pay PMI (private mortgage insurance) which adds $100-300+ monthly, but many successful homeowners start this way. FHA loans require just 3.5% down, and some conventional loans accept 3%.",
            },
            {
              question: "How do I calculate how much house I can afford?",
              answer:
                "Use the 28/36 rule: housing costs shouldn't exceed 28% of gross monthly income, and total debt payments shouldn't exceed 36%. Include property taxes, insurance, and PMI in your calculations. Get pre-approved to know your exact buying power.",
            },
            ...
            // What-If Scenarios
            {
              ...
              answer:
                "Get a rate lock from your lender (typically 30-60 days) to protect against rate increases during your home purchase. If rates drop, some lenders offer float-down options. Without a rate lock, your payment could increase significantly if rates rise.",
            },
            {
              question: "What if I lose my job after buying a house?",
              answer:
                "Contact your lender immediately to discuss options like loan modification, forbearance, or refinancing. Maintain an emergency fund of 3-6 months of payments. Consider mortgage protection insurance or ensure adequate life/disability insurance coverage before purchasing.",
            },
            {
              question: "Should I buy now or wait for rates to come down?",
              answer:
                "Timing the market is difficult. If you're financially ready and plan to stay 5+ years, buying now might make sense - you can refinance later if rates drop. Waiting risks home price increases that could offset rate savings. Focus on your personal financial readiness.",
            },
            ...
            // Technical Mortgage Terms
            {
              ...
              answer:
                "PITI stands for Principal, Interest, Taxes, and Insurance - your complete monthly housing payment. Principal builds equity, interest is the loan cost, taxes fund local services, and insurance protects you and the lender. This is your true cost of homeownership.",
            },
            {
              question: "What is PMI and when can I remove it?",
              answer:
                "Private Mortgage Insurance (PMI) protects lenders when you put less than 20% down. It costs 0.3-1.5% of loan amount annually. You can request removal at 20% equity or it automatically cancels at 22%. Some loans require PMI for the loan's lifetime.",
            },
            {
              question: "What's the difference between APR and interest rate?",
              answer:
                "Interest rate is the yearly cost of borrowing money. APR (annual percentage rate) includes the interest rate plus other loan costs like origination fees and PMI. APR gives you the true cost of the loan and is better for comparing lenders.",
            },
            ...
            // Comparison Questions
            {
              ...
              answer:
                "Buy if you'll stay 5+ years, have stable income, 3-5% down payment, and closing costs covered. Rent if you plan to move soon, prefer flexibility, or want to invest the down payment money elsewhere. Use a rent vs buy calculator for your specific situation.",
            },
            {
              question: "Should I pay off my mortgage early or invest?",
              answer:
                "If your mortgage rate is below 6-7%, investing typically offers better long-term returns. If above 7% or you prefer guaranteed savings, extra mortgage payments make sense. Consider your risk tolerance, other debt, and retirement savings first.",
            },
            ...
            // Process and Timeline Questions
            {
              ...
              answer:
                "Pre-approval takes 1-3 days with your documents ready. Full approval takes 30-45 days after your offer is accepted. Factors affecting timeline include document completeness, property appraisal, and lender workload. Shop for lenders early in your process.",
            },
            {
              question: "What credit score do I need to buy a house?",
              answer:
                "Minimum credit scores: FHA loans 580, conventional loans 620, VA/USDA loans 580+. However, 740+ gets the best rates. If your score is low, focus on improving it before applying - even a 20-point increase can save thousands in interest.",
            },
            {
              question: "How much are closing costs and who pays them?",
              answer:
                "Closing costs typically run 2-5% of home price. Buyers usually pay loan origination, appraisal, inspection, title insurance, and prepaid items. Sellers typically pay realtor commissions. You can negotiate who pays what or ask for seller concessions.",
            },
          ]}
        />
