...
export const APP_STORE_REVIEW_COUNT = 92;
export const PLAY_STORE_REVIEW_COUNT = 24;
...
export const appStoreReviews: Review[] = [
  ...
  },
  {
    ...
    body: "Thanks for this great app. Can you add Syrian Pound currency?",
  ...
  },
  {
    ...
    rating: 5,
    title: "Nice features",
    body: "There's a lot of cool features that traditional or normal expense tracker doesn't have. Especially loving the shared budget feature where you can add in multiple members.",
    reviewerNickname: "elluelelf",
    createdDate: "2026-07-13T00:00:00-08:00",
    territory: "MYS",
  },
  {
    id: "review-027",
    ...
    body: "I have been using it since their beta release, and I have to say it is getting better and better now! Good job moneko dev🔥",
    reviewerNickname: "WH904",
    createdDate: "2026-07-11T00:00:00-08:00",
    territory: "IRL",
  },
  {
    id: "review-028",
    rating: 5,
    title: "RECOMMENDEDDD",
    body: "I've been using this every day and it's been great. Easy to keep track of expenses and no need to record the transaction manually one by one. Definitely recommend!",
    reviewerNickname: "Ying Charlotte",
    createdDate: "2026-07-10T00:00:00-08:00",
    territory: "MYS",
  },
  {
    id: "review-029",
    rating: 5,
    title: "I'm glad I found it!!!",
    body: "Adding transactions is quick, the budgeting and expense tracking features are very helpful. I organize my transactions and see where the money is going easily. The app design is straightforward and easy to setup. Definitely the best budgeting app I've tried so far.",
    reviewerNickname: "Moimeme560",
    createdDate: "2026-07-13T00:00:00-08:00",
    territory: "CAN",
  },
  {
    ...
    rating: 5,
    title: "Love it!!!",
    body: "Love how easy it is to input and share your expenses! Apple wallet makes it even better!",
    reviewerNickname: "maximaomega",
    createdDate: "2026-07-11T00:00:00-08:00",
    territory: "NLD",
  },
  {
    id: "review-031",
    rating: 5,
    title: "Not your average expense tracker",
    body: "AI for expenses just work. Smart budgets, guidance and clean answer to question \"where is my money going\" are extremely helpful",
    reviewerNickname: "Not an Average Reader",
    createdDate: "2026-07-02T00:00:00-08:00",
    territory: "POL",
  },
  {
    id: "review-032",
    rating: 5,
    title: "One of the best one so far.",
    body: "One of the best expense tracking apps I've tried so far. It imported all my records from my previous app seamlessly, and the spending insights make it easy to stay on track. The developer is also incredibly responsive and genuinely listens to feedback, bugs I reported were fixed almost immediately. A few small things are still being ironed out, but the app keeps getting better. Highly recommend!",
    reviewerNickname: "Ntch32",
    createdDate: "2026-06-03T00:00:00-08:00",
    territory: "USA",
  },
  {
    id: "review-033",
    rating: 5,
    title: "Tuyệt vời",
    body: "Ứng dụng ok lắm",
    reviewerNickname: "hthonh",
    createdDate: "2026-06-25T00:00:00-08:00",
    territory: "VNM",
  },
  {
    id: "review-034",
    rating: 5,
    title: "Smartest money tracker app",
    body: "It's super convenient to record and track my expenses without having me to press too many buttons. Super helpful and smart, thanks 💪🏼",
    reviewerNickname: "jessj.930",
    createdDate: "2026-05-25T00:00:00-08:00",
    territory: "MYS",
  },
  {
    id: "review-035",
    ...
    body: "Really fantastic budgeting app — straightforward, easy to use and integrate, helpful. The interface is very natural and it all works very smoothly.",
    reviewerNickname: "User34862",
    createdDate: "2026-02-19T00:00:00-08:00",
    territory: "USA",
  },
  {
    id: "review-036",
    rating: 5,
    title: "Smooth and impressive experience",
    body: "Clean interface and fast. Everything feels intuitive and well thought out. No unnecessary clutter.",
    reviewerNickname: "Tanay Arya",
    createdDate: "2026-02-02T00:00:00-08:00",
    territory: "IND",
  },
  {
    id: "review-037",
    rating: 5,
    title: "Good",
    body: "Nice app but it need more currency, I hope to see it in next update like MMK Myanmar(k)",
    reviewerNickname: "YoungNikolas",
    createdDate: "2026-01-31T00:00:00-08:00",
    territory: "USA",
  },
  {
    id: "review-038",
    rating: 5,
    title: "Falling in love with this app!",
    body: "😍 falling in love with this app! Love how easy to input expenses - The insights are also helpful to reflect back how I've used my money",
    reviewerNickname: "thomas Budiman",
    createdDate: "2026-07-14T00:00:00-08:00",
    territory: "USA",
  },
  {
    id: "review-039",
    rating: 5,
    title: "WhatsApp expense management!",
    body: "I love it that I can manage my expenses from my WhatsApp!",
    reviewerNickname: "r",
    createdDate: "2026-07-13T00:00:00-08:00",
    territory: "USA",
  },
  {
    id: "review-040",
    rating: 5,
    title: "Interesting and intuitive design",
    body: "Interesting and intuitive design",
    reviewerNickname: "Mohsen Rezania",
    createdDate: "2026-07-11T00:00:00-08:00",
    territory: "USA",
  },
];
