...
export const helpCenterData: FAQCategory[] = [
  {
    ...
    description: 'Everything you need to know to begin your financial journey with Moneko',
    icon: 'Rocket',
    questions: [
      {
        id: 'what-is-moneko',
        question: 'What is Moneko and how can it help me manage my finances?',
        answer: 'Moneko is an AI-powered financial education and planning platform that combines personalized financial guidance with interactive learning. It helps you track financial goals, learn about money management through AI-generated courses, chat with a financial advisor AI, use powerful calculators, and assess your financial health.[1][2] Moneko is designed for anyone looking to improve their financial literacy and take control of their money, whether you are just starting out or looking to optimize your existing financial strategy.[3] The platform uses Google Gemini AI to provide contextual, personalized financial advice based on your unique situation.',
        category: 'getting-started',
        keywords: ['introduction', 'overview', 'what is moneko', 'financial platform', 'ai advisor', 'financial education', 'money management app'],
        relatedQuestions: ['how-to-sign-up', 'moneko-features', 'who-is-moneko-for']
      },
      {
        id: 'how-to-sign-up',
        question: 'How do I create a Moneko account and get started?',
        answer: 'Creating a Moneko account is simple and takes less than 2 minutes. Visit moneko.ai and click "Sign Up" in the top right corner. You can sign up using your email address or use Google OAuth for instant access. After signing up, you will be guided through a quick onboarding process where you can set your financial goals, take an optional financial health assessment, and customize your dashboard. The free tier gives you access to basic features immediately, with premium features available through subscription.',
        category: 'getting-started',
        keywords: ['sign up', 'create account', 'registration', 'onboarding', 'getting started', 'new user', 'account creation'],
        relatedQuestions: ['what-is-moneko', 'free-vs-premium', 'onboarding-process']
      },
      {
        id: 'moneko-features',
        question: 'What features does Moneko offer?',
        answer: 'Moneko offers a comprehensive suite of financial tools: (1) AI Financial Advisor - chat with an AI that understands your financial situation and provides personalized advice.[4] (2) Goal Tracker - set and track financial goals with AI-generated strategies and milestones. (3) Learning Platform - interactive courses on budgeting, investing, debt management, and more. (4) Financial Calculators - mortgage, retirement, compound interest, auto loan, investment, and savings goal calculators. (5) Financial Health Assessment - comprehensive quiz that analyzes your finances and provides actionable recommendations. (6) Customizable Dashboard - drag-and-drop widgets to visualize your financial data. (7) Gamification - earn XP and level up as you learn and achieve goals.[5]',
        category: 'getting-started',
        keywords: ['features', 'capabilities', 'what can moneko do', 'tools', 'services', 'platform features'],
        relatedQuestions: ['goal-tracker-explained', 'ai-advisor-capabilities', 'calculator-types']
      },
      {
        id: 'who-is-moneko-for',
        question: 'Who is Moneko designed for?',
        answer: 'Moneko is designed for anyone looking to improve their financial situation, regardless of their current knowledge level or financial status. It is perfect for: young adults just starting their financial journey, individuals looking to pay off debt, people saving for major life goals like buying a house or wedding, those wanting to learn about investing, families budgeting together, side hustlers tracking multiple income streams, and anyone seeking personalized financial guidance without expensive financial advisors. Whether you are earning $20k or $200k per year, Moneko adapts to your situation.',
        category: 'getting-started',
        keywords: ['target audience', 'who should use', 'user personas', 'suitability', 'beginners', 'millennials', 'gen z'],
  ...
  },
  {
    ...
    description: 'Understanding the capabilities and limitations of your personal AI financial guide.',
    icon: 'Brain',
    questions: [
      {
        id: 'ai-advisor-capabilities',
        question: 'What can the Moneko AI Financial Advisor do for me?',
        answer: 'The Moneko AI Advisor acts as your personal financial guide, available 24/7.[13] You can ask it a wide range of questions, such as: "How can I create a budget based on my income?", "Explain the difference between a Roth IRA and a 401(k)", "What\'s a good strategy to pay off my credit card debt faster?", or "Analyze my spending and tell me where I can save money." The AI provides personalized, conversational answers, creates financial plans, and explains complex topics in simple terms.[14]',
        category: 'ai-financial-advisor',
        keywords: ['ai advisor', 'capabilities', 'what it does', 'ask ai', 'financial questions', 'personalized advice'],
        relatedQuestions: ['ai-advisor-limitations', 'ai-vs-human-advisor', 'ai-advisor-privacy']
      },
      {
        id: 'ai-advisor-technology',
        question: 'What technology powers the Moneko AI Financial Advisor?',
        answer: 'The Moneko AI Financial Advisor is powered by Google\'s advanced large language model (LLM), Gemini. This model is specifically fine-tuned with a vast library of expert-vetted financial knowledge, including articles, books, and case studies. This allows the AI to understand the nuances of personal finance and provide contextually relevant, accurate, and safe financial guidance. It combines natural language processing with predictive analytics to deliver tailored advice.[13]',
        category: 'ai-financial-advisor',
        keywords: ['technology', 'how it works', 'google gemini', 'llm', 'ai model', 'natural language processing'],
        relatedQuestions: ['ai-advisor-capabilities', 'ai-advisor-data-source', 'is-ai-advice-reliable']
      },
      {
        id: 'is-ai-advice-reliable',
        question: 'Is the financial advice from the Moneko AI reliable and accurate?',
        answer: 'Our AI provides reliable educational guidance based on established financial principles. The AI is trained on a curated database of high-quality financial information and its responses are continuously reviewed by human financial experts for accuracy and safety. However, the AI\'s advice is for informational and educational purposes only and should not be considered a substitute for professional, regulated financial advice from a certified human advisor, especially for complex financial decisions. Always do your own research or consult a qualified professional.',
        category: 'ai-financial-advisor',
        keywords: ['reliability', 'accuracy', 'trustworthy', 'fact check', 'safe advice', 'is it safe'],
        relatedQuestions: ['ai-advisor-limitations', 'ai-vs-human-advisor', 'disclaimer']
      },
      {
        id: 'ai-advisor-limitations',
        question: 'What are the limitations of the AI Financial Advisor?',
        answer: 'The Moneko AI Financial Advisor is a powerful tool but has important limitations. It is not a licensed fiduciary or certified financial planner. It cannot provide regulated financial advice, such as recommending specific stocks or financial products. The AI does not have access to your live, personal bank account data for privacy reasons. Its advice is based solely on the information you provide in your profile and during conversations. For personalized investment or legal advice, you must consult a qualified human professional.',
        category: 'ai-financial-advisor',
        keywords: ['limitations', 'what it cannot do', 'disclaimer', 'not a fiduciary', 'regulated advice', 'restrictions'],
        relatedQuestions: ['is-ai-advice-reliable', 'ai-vs-human-advisor', 'data-privacy']
      },
      {
        id: 'ai-vs-human-advisor',
        question: 'How does the Moneko AI compare to a human financial advisor?',
        answer: 'The Moneko AI is best seen as a complementary tool, not a replacement. Moneko AI: available 24/7, low-cost, great for financial education, goal planning, and general strategy.[13] Human Advisor: licensed professional, provides regulated and legally binding advice, handles complex situations (e.g., estate planning, complex taxes), and can be held accountable. We recommend using Moneko to build your financial literacy and manage day-to-day finances, and consulting a human advisor for major life decisions and specialized advice.',
        category: 'ai-financial-advisor',
        keywords: ['human vs ai', 'comparison', 'replace human', 'fiduciary', 'financial planner', 'cfp'],
        relatedQuestions: ['ai-advisor-limitations', 'is-ai-advice-reliable', 'when-to-use-human-advisor']
      },
      {
        id: 'ai-advisor-privacy',
        question: 'Are my conversations with the AI Advisor private?',
        answer: 'Yes, your conversations are private and secure. All chat data is encrypted. We use anonymized conversation data solely to train and improve the AI model’s accuracy and safety. We will never sell your personal conversation data to third parties. You have the option to delete your conversation history at any time from your account settings.',
        category: 'ai-financial-advisor',
        keywords: ['privacy', 'confidentiality', 'secure chat', 'data protection', 'conversation history', 'anonymized data'],
        relatedQuestions: ['platform-security', 'data-privacy', 'delete-my-data']
      }
    ]
  },
  {
    ...
    description: 'Improve your financial literacy with AI-powered courses and interactive content.',
    icon: 'BookOpen',
    questions: [
      {
        id: 'learning-platform',
        question: 'How does the Moneko learning platform work?',
        answer: 'The Moneko learning platform offers interactive, bite-sized courses on key financial topics like budgeting, saving, investing, and debt management.[3] Courses are powered by AI to adapt to your skill level and goals. As you complete lessons and quizzes, you earn XP and level up, making learning engaging.[15] Premium users can access AI-generated custom courses tailored to their specific questions and financial situation.',
        category: 'learning-education',
        keywords: ['learning', 'education', 'courses', 'financial literacy', 'how to learn', 'interactive lessons'],
        relatedQuestions: ['course-topics', 'gamification-system', 'ai-custom-courses']
      },
      {
        id: 'course-topics',
  ...
  },
  {
    ...
    description: 'Tools to help you plan for major financial decisions like retirement, mortgages, and investments.',
    icon: 'Calculator',
    questions: [
      {
        id: 'calculator-types',
        question: 'What financial calculators does Moneko offer?',
        answer: 'Moneko provides a suite of powerful calculators to help with financial planning: Retirement Calculator, Mortgage Calculator, Compound Interest Calculator, Auto Loan Calculator, Investment Calculator, and Savings Goal Calculator. Each calculator is designed to be user-friendly, with clear explanations for each input and visual charts to display the results.',
        category: 'financial-calculators',
        keywords: ['calculators', 'tools', 'planning tools', 'financial planning', 'list of calculators'],
        relatedQuestions: ['retirement-calculator-details', 'mortgage-calculator-details', 'compound-interest-explainer']
      },
      {
        id: 'retirement-calculator-details',
        question: 'How does the Retirement Calculator work?',
        answer: 'The Retirement Calculator helps you estimate how much you need to save for a comfortable retirement.[17][18] You input your current age, desired retirement age, annual income, current retirement savings, and monthly contributions.[19] The calculator then projects your future savings growth, factoring in estimated investment returns and inflation, to show if you are on track to meet your retirement goals. You can adjust the variables to see how changes impact your outcome.[20][21]',
        category: 'financial-calculators',
        keywords: ['retirement calculator', 'how much to save', 'retirement planning', '401k calculator', 'pension planning'],
        relatedQuestions: ['calculator-types', 'investment-calculator-details', 'compound-interest-explainer']
      },
      {
        id: 'mortgage-calculator-details',
        question: 'What can I do with the Mortgage Calculator?',
        answer: 'The Mortgage Calculator helps you understand the costs of buying a home. You can: (1) Estimate Monthly Payments by entering the home price, down payment, interest rate, and loan term. (2) View an Amortization Schedule that shows how much of each payment goes toward principal vs. interest over time. (3) Compare Different Scenarios by adjusting the interest rate or loan term to see the impact on your monthly payment and total interest paid.',
        category: 'financial-calculators',
        keywords: ['mortgage calculator', 'home loan', 'monthly payment', 'amortization', 'house payment'],
        relatedQuestions: ['calculator-types', 'auto-loan-calculator', 'savings-goal-calculator']
      },
      {
        id: 'compound-interest-explainer',
        question: 'How does the Compound Interest Calculator work?',
        answer: 'This calculator visually demonstrates the power of compound interest. You enter an initial investment, a regular contribution amount, an estimated interest rate, and the time period. The calculator then shows a graph illustrating how your investment grows over time, distinguishing between your principal contributions and the interest earned on interest. It’s a powerful tool to motivate long-term saving and investing.',
        category: 'financial-calculators',
        keywords: ['compound interest', 'investment growth', 'calculating interest', 'long-term savings', 'investing'],
        relatedQuestions: ['calculator-types', 'investment-calculator-details', 'retirement-calculator-details']
      }
    ]
  },
  {
    ...
    description: 'Manage your Moneko account, subscription plans, and billing details.',
    icon: 'UserCircle',
    questions: [
      {
        id: 'free-vs-premium',
        question: 'What is the difference between Moneko Free and Premium?',
        answer: 'Free Plan: Designed to get you started. Includes tracking for up to 3 financial goals, access to all standard calculators, introductory learning courses, and a limited number of conversations with the AI Advisor each month. \nPremium Plan: Unlocks the full power of Moneko. Includes unlimited goal tracking, unlimited AI Advisor conversations, advanced AI-generated custom courses, detailed analytics, advanced dashboard customization, and priority customer support.',
        category: 'account-subscription',
        keywords: ['free vs premium', 'plan comparison', 'subscription tiers', 'upgrade', 'pricing plans'],
        relatedQuestions: ['cost-and-pricing', 'how-to-upgrade', 'cancel-subscription']
      },
      {
        id: 'how-to-upgrade',
        question: 'How do I upgrade to a Premium subscription?',
        answer: 'You can upgrade to Premium at any time from your account settings. Navigate to the "Subscription" tab in your profile, choose between a monthly or annual plan, and enter your payment details. Our payments are processed securely by Stripe. Your account will be upgraded instantly, and you will gain immediate access to all premium features.',
        category: 'account-subscription',
        keywords: ['upgrade', 'go premium', 'subscribe', 'payment', 'get premium'],
        relatedQuestions: ['free-vs-premium', 'payment-methods', 'free-trial']
      },
      {
        id: 'cancel-subscription',
        question: 'How can I cancel my Premium subscription?',
        answer: 'You can cancel your Premium subscription at any time. Go to your account settings, click on the "Subscription" tab, and select "Cancel Subscription." Your subscription will remain active until the end of the current billing period, and you will not be charged again. You can continue to use all premium features until your subscription expires. Your account will then revert to the Free plan.',
        category: 'account-subscription',
        keywords: ['cancel', 'unsubscribe', 'end subscription', 'cancellation policy', 'stop payment'],
        relatedQuestions: ['refund-policy', 'free-vs-premium', 'manage-subscription']
      },
      {
        id: 'refund-policy',
        ...
        category: 'account-subscription',
        keywords: ['refund', 'money back', 'satisfaction guarantee', 'refund policy', 'get a refund'],
        relatedQuestions: ['cancel-subscription', 'cost-and-pricing', 'contact-support']
      },
      {
        id: 'delete-my-data',
        question: 'How do I delete my Moneko account and data?',
        answer: 'You can permanently delete your account and all associated data from your account settings page. Scroll to the bottom and select "Delete Account." You will be asked to confirm your password. Please note that this action is irreversible and will permanently erase all your goals, progress, and conversation history. For security reasons, the deletion process may take up to 30 days to complete.',
        category: 'account-subscription',
        keywords: ['delete account', 'remove data', 'data deletion', 'close account', 'privacy', 'right to be forgotten'],
        relatedQuestions: ['data-privacy', 'goal-deletion', 'platform-security']
      }
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        category: 'security-privacy',
        keywords: ['data sharing', 'third parties', 'selling data', 'partners', 'anonymized data'],
        relatedQuestions: ['data-privacy', 'privacy-policy-link', 'platform-security']
      },
      {
        id: 'two-factor-auth',
        question: 'Does Moneko support Two-Factor Authentication (2FA)?',
        answer: 'Yes, we highly recommend enabling Two-Factor Authentication (2FA) to add an extra layer of security to your account.[6][8] You can enable 2FA in your account security settings. We support both authenticator apps (like Google Authenticator) and SMS-based codes. With 2FA enabled, you will need to provide a code from your device in addition to your password when logging in.',
        category: 'security-privacy',
        keywords: ['2fa', 'two-factor authentication', 'mfa', 'account security', 'secure login', 'authenticator app'],
        relatedQuestions: ['platform-security', 'password-security', 'what-if-locked-out']
      },
      {
        id: 'bank-connections',
        question: 'Does Moneko connect to my bank accounts?',
        answer: 'No, Moneko does not currently offer direct bank connections or account aggregation. All financial data, such as goal progress, income, and expenses, is self-reported by the user. This approach maximizes your privacy and security, as we never have access to your bank credentials or live transaction data. While it requires manual updates, it gives you full control over what information you share.',
        category: 'security-privacy',
        keywords: ['bank connection', 'plaid', 'account aggregation', 'linking accounts', 'data access', 'manual entry'],
        relatedQuestions: ['data-privacy', 'platform-security', 'updating-progress']
      },
      {
        id: 'privacy-policy-link',
        question: 'Where can I read the full Privacy Policy and Terms of Service?',
        answer: 'You can access our legal documents at any time. The full Privacy Policy is available at moneko.ai/privacy and our Terms of Service can be found at moneko.ai/terms. We encourage you to read them to fully understand your rights and our responsibilities.',
        category: 'security-privacy',
        keywords: ['privacy policy', 'terms of service', 'legal', 'user agreement', 'data agreement'],
    ...
    questions: [
      {
        ...
        answer: 'If you are facing a technical problem, please try these steps first: (1) Refresh the page to resolve temporary loading issues. (2) Clear your browser cache and cookies, as outdated data can cause problems. (3) Update your browser to the latest version. (4) Try a different browser to see if the issue is browser-specific. If the problem persists, please contact our support team with a detailed description of the issue and any screenshots you can provide.',
        category: 'troubleshooting',
        keywords: ['technical support', 'bug', 'error', 'not working', 'glitch', 'troubleshooting'],
        relatedQuestions: ['contact-support', 'browser-compatibility', 'system-status']
      },
      {
        id: 'contact-support',
        question: 'How can I contact the Moneko support team?',
        answer: 'You can contact our support team in two ways: (1) Email: Send a message to support@moneko.ai. We typically respond within 24-48 hours. (2) Contact Form: Use the contact form on our website at moneko.ai/contact. Premium users have access to priority support, which guarantees a response within 12 hours.',
        category: 'troubleshooting',
        keywords: ['contact', 'support', 'help', 'customer service', 'email support', 'get in touch'],
        relatedQuestions: ['technical-issues', 'feature-request', 'premium-support']
      },
      {
        id: 'password-reset',
        question: 'I forgot my password. How can I reset it?',
        answer: 'If you forgot your password, click the "Forgot Password?" link on the login page. Enter the email address associated with your Moneko account, and we will send you a secure link to reset your password. If you signed up using Google OAuth, you will need to manage your password through your Google account.',
        category: 'troubleshooting',
        keywords: ['forgot password', 'password reset', 'change password', 'login help', 'account access'],
        relatedQuestions: ['what-if-locked-out', 'two-factor-auth']
      },
      {
        id: 'feature-request',
        question: 'How can I suggest a new feature for Moneko?',
        answer: 'We love hearing ideas from our users! You can submit a feature request through our community forum at feedback.moneko.ai. You can post new ideas, vote on existing suggestions from other users, and see what our development team is currently working on. Many of our new features come directly from user feedback.',
        category: 'troubleshooting',
        keywords: ['feature request', 'suggestion', 'idea', 'feedback', 'product improvement'],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        category: 'general-financial-advice',
        keywords: ['negotiate salary', 'ask for raise', 'salary negotiation', 'negotiate job offer', 'increase salary', 'pay raise tips'],
      ...
      },
      {
        ...
        category: 'general-financial-advice',
        keywords: ['financial goals examples', 'money goals', 'savings goals ideas', 'financial objectives', 'goal setting finance'],
      ...
      },
      {
        ...
        category: 'general-financial-advice',
        keywords: ['financial audit', 'financial checkup', 'assess finances', 'financial health check', 'review finances'],
  ...
  },
  {
    ...
    description: 'Everything about high-yield savings accounts, CDs, and where to keep your cash',
    icon: 'PiggyBank',
    questions: [
      {
...
export const totalQuestions = helpCenterData.reduce((acc, cat) => acc + cat.questions.length, 0);
...
export const allKeywords = Array.from(
  new Set(helpCenterData.flatMap(cat => cat.questions.flatMap(q => q.keywords)))
).sort();