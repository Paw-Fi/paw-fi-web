...
export const envelopeBudgetingArticle: HelpArticle = {
  id: "envelope-budgeting",
  number: "3.1",
  slug: "envelope-budgeting-moneko",
  title: "How to Use Envelope Budgeting in Moneko",
  description:
  ...
  readTime: 5,
  keywords: [
    "envelope budgeting in Moneko",
    "Moneko envelope budgeting",
    "Moneko Pockets",
    "Pocket budgeting",
  ...
  faqItems: [
    ...
    {
      question: "What are envelopes called in Moneko?",
      answer: "In Moneko, envelopes are called Pockets.",
    },
    {
      question: "How does Moneko use Pockets for budgeting?",
      answer:
        "You set a monthly plan, log expenses, and Moneko keeps your Pocket balances updated automatically.",
    },
    {
      question: "Do I need to use spreadsheets for envelope budgeting in Moneko?",
      answer:
        "No. Moneko keeps balances updated automatically, so you do not need to manage spreadsheets or calculate totals manually.",
    },
    {
      question: "What budget categories should I start with?",
      answer: "Start with a few main categories such as Rent, Groceries, Dining, Travel, Fun, and Savings.",
    },
    {
      question: "Do I need to make my budget perfect from the start?",
      answer: "No. Start with a rough plan that reflects how you spend. You can adjust it over time.",
    },
    {
      question: "What happens when I log an expense?",
      answer: "Moneko organizes the expense into the right Pocket and updates the remaining balance.",
    },
    {
      question: "Should I check my Pocket before spending?",
      answer: "Yes. Checking before you spend helps you make better decisions in the moment.",
    },
    {
      question: "Can I adjust my budget during the month?",
      answer:
        "Yes. If one category runs low, you can move budget from another category, reduce spending, or adjust your overall plan.",
    },
    {
      question: "Do I need to rebuild my budget every month?",
      answer: "No. You can reuse your existing setup and make small adjustments over time.",
    },
  ],
  howToSteps: [
    {
      name: "Set a monthly plan",
      text: "Divide your total monthly budget into clear categories (Pockets).",
    },
    {
      name: "Log expenses naturally",
      text: "Add expenses as they happen; Moneko will assign them to the correct Pocket.",
    },
    {
      name: "Check remaining balance",
...
2. Log your expenses.
3. Check your remaining balance when needed.
