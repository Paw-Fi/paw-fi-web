...
const changelogs: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Improved app performance and responsiveness when adding, editing, or deleting transactions",
      "Fixed an issue where wallet amounts on the wallets page could display incorrectly",
    ],
  },
  {
