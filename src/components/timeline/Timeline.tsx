...
export function Timeline() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 px-3">
        <div className="text-center">
          <LoadingSpinner />
          <p className="mt-4 text-gray-600 dark:text-slate-400 text-mobile-sm sm:text-sm">Loading your timeline...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 px-3">
        <div className="text-center max-w-md p-6 sm:p-8 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-lg">
          <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-4 bg-red-100 dark:bg-red-500/20 rounded-full flex items-center justify-center">
          ...
          <h2 className="text-mobile-base sm:text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-2">
            Unable to load timeline
          </h2>
          <p className="text-mobile-sm sm:text-sm text-gray-600 dark:text-slate-400">
