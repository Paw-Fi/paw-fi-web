  ...
  return (
    <div className={`relative ${className}`} ref={popoverRef}>
      <Button
        ...
        className="border-border hover:bg-muted w-full justify-between px-1 py-1 transition-colors"
      >
      ...
      {isOpen && (
        <div className="bg-moneko-background border-border absolute z-50 mt-1 w-full rounded-md border shadow-lg">
