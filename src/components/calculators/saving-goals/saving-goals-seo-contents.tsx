  ...
  return (
    <section className="max-w-5xl mx-auto mt-16 mb-20 px-4 md:px-6 text-foreground dark:text-dark-foreground font-sans">
      <div className="mb-12 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground dark:text-dark-foreground">Achieving Your Saving Goals</h2>
      ...
      <div className="bg-card dark:bg-dark-card rounded-2xl shadow-sm p-6 md:p-8 mb-10 border border-subtle-border dark:border-dark-subtle-border">
        <h3 className="text-2xl font-bold mb-4 text-foreground dark:text-dark-foreground">How Do Saving Goals Work?</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
        <div className="bg-gradient-to-br from-primary/5 to-accent/10 dark:from-dark-primary/5 dark:to-dark-accent/10 rounded-2xl shadow-sm p-6 md:p-8 border border-primary/20 dark:border-dark-primary/20">
          <div className="flex items-center mb-5">
            ...
            <h3 className="text-xl font-bold text-foreground dark:text-dark-foreground">Key Saving Terms</h3>
          </div>
        ...
        <div className="bg-gradient-to-br from-secondary/10 to-accent/10 dark:from-dark-secondary/10 dark:to-dark-accent/10 rounded-2xl shadow-sm p-6 md:p-8 border border-secondary/20 dark:border-dark-secondary/20">
          <div className="flex items-center mb-5">
            ...
            <h3 className="text-xl font-bold text-foreground dark:text-dark-foreground">Benefits of Setting Saving Goals</h3>
          </div>
          <ul className="space-y-4">
            {[
      ...
      <div className="bg-gradient-to-br from-success/10 to-accent/10 dark:from-dark-success/10 dark:to-dark-accent/10 rounded-2xl shadow-sm p-6 md:p-8 mb-10 border border-success/20 dark:border-dark-success/20">
        <div className="flex items-center mb-6">
          ...
          <h3 className="text-xl font-bold text-foreground dark:text-dark-foreground">Smart Saving Strategies</h3>
        </div>
      ...
      {/* SMART Goals Section */}
      <div className="bg-gradient-to-br from-secondary/10 to-accent/10 dark:from-dark-secondary/10 dark:to-dark-accent/10 rounded-2xl shadow-sm p-6 md:p-8 mb-10 border border-secondary/20 dark:border-dark-secondary/20">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-xl font-bold text-foreground dark:text-dark-foreground">Setting SMART Saving Goals</h3>
        </div>
        ...
        <div className="bg-card dark:bg-dark-card rounded-xl p-5 shadow-sm border border-subtle-border dark:border-dark-subtle-border">
          <h4 className="font-semibold text-foreground dark:text-dark-foreground mb-3">The SMART Framework:</h4>
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <div>
                <span className="font-semibold text-foreground dark:text-dark-foreground">Specific:</span>
                <span className="text-muted-foreground dark:text-dark-muted-foreground ml-1">Define your goal clearly. Instead of "save money for a car," specify "save $10,000 for a down payment on a Toyota Camry."</span>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                <span className="font-semibold text-foreground dark:text-dark-foreground">Measurable:</span>
                <span className="text-muted-foreground dark:text-dark-muted-foreground ml-1">Establish concrete criteria for measuring progress. Track how much you've saved and how close you are to your target amount.</span>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                <span className="font-semibold text-foreground dark:text-dark-foreground">Achievable:</span>
                <span className="text-muted-foreground dark:text-dark-muted-foreground ml-1">Set goals that are realistic given your income and expenses. Saving 80% of your income might not be achievable, but 15-20% could be.</span>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                <span className="font-semibold text-foreground dark:text-dark-foreground">Relevant:</span>
                <span className="text-muted-foreground dark:text-dark-muted-foreground ml-1">Ensure your goal aligns with your broader financial plans and life objectives. The goal should matter to you personally.</span>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                <span className="font-semibold text-foreground dark:text-dark-foreground">Time-bound:</span>
                <span className="text-muted-foreground dark:text-dark-muted-foreground ml-1">Set a deadline for your goal. "Save $10,000 for a car down payment by December 31, 2026" gives you a clear timeframe.</span>
              </div>
            </li>
          </ul>
        </div>
      ...
      {/* FAQ Section */}
      <FaqSection faqData={savingGoalsFaqData} />
