...
export function HeroV2() {
          ...
          <div className="mx-auto flex max-w-4xl flex-col items-center space-y-8">
            ...
            <div className="text-muted-foreground flex items-center justify-center gap-4 pt-4 text-sm">
              <div className="flex -space-x-2">
               ...
               <svg className="size-8" xmlns="http://www.w3.org/2000/svg" width="256" height="256" fill="none" viewBox="0 0 256 256" id="whatsapp">
  ...
  <path fill="#25D366" d="M102.737 96.0382C103.483 95.7055 104.288 95.526 105.104 95.51L105.245 95.4899C106.351 95.5234 107.457 95.5569 108.422 95.624L108.429 95.6245C109.6 95.7115 110.937 95.8108 112.061 98.653C113.448 101.984 116.403 110.287 116.798 111.131C117.047 111.574 117.181 112.072 117.189 112.58C117.198 113.087 117.079 113.589 116.846 114.04C116.394 115.011 115.807 115.913 115.103 116.72C114.245 117.665 113.354 118.757 112.523 119.549C111.692 120.339 110.781 121.21 111.692 122.899C114.05 127.25 117.04 131.227 120.565 134.7C124.337 138.394 128.767 141.349 133.626 143.412C134.188 143.707 134.808 143.874 135.442 143.902C135.786 143.896 136.125 143.817 136.437 143.672C136.748 143.526 137.026 143.317 137.251 143.057C138.284 142.012 141.36 138.386 142.7 136.717C142.909 136.375 143.198 136.088 143.542 135.883C143.887 135.677 144.276 135.559 144.677 135.538C145.292 135.584 145.894 135.74 146.453 136C147.961 136.604 155.982 140.892 157.618 141.75C159.253 142.608 160.338 143.091 160.734 143.761C161.129 144.431 161.029 147.782 159.527 151.615C158.026 155.448 151.144 158.973 148.094 159.161C147.19 159.215 146.326 159.335 145.179 159.335C142.398 159.335 138.11 158.612 128.325 154.396C111.678 147.246 101.573 129.614 100.775 128.481L100.769 128.472C99.9478 127.306 94.2755 119.252 94.5294 111.111C94.7841 102.949 99.187 99.0618 100.762 97.4468C101.319 96.8499 101.991 96.3709 102.737 96.0382Z"></path>
</svg>
                {/* Telegram */}
    ...
    <linearGradient id="paint0_linear_533_2162" x1="128.001" x2="128.001" y1="61.333" y2="194.666" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="1" stop-color="#229ED9"></stop>
                ...
                {/* <a href="https://iconscout.com/icons/wallet" class="text-underline font-size-sm" target="_blank">wallet</a> by <a href="https://iconscout.com/contributors/icon-mafia" class="text-underline font-size-sm">Icon Mafia</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a> */}
                 ...
                 <svg className="size-6 translate-y-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" id="wallet">
  <path fill="#1e1e1f" d="M26,0H94a25.9482,25.9482,0,0,1,26,26V94a25.9482,25.9482,0,0,1-26,26H26A25.9482,25.9482,0,0,1,0,94V26A26.012,26.012,0,0,1,26,0Z"></path>
  <path fill="#fff" fill-rule="evenodd" d="M24,30H96a6.01764,6.01764,0,0,1,6,6V70a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V36A6.01764,6.01764,0,0,1,24,30Z"></path>
  <path fill="#d9d6cc" fill-rule="evenodd" d="M22,26H98a8.02352,8.02352,0,0,1,8,8V86a8.02352,8.02352,0,0,1-8,8H22a8.02352,8.02352,0,0,1-8-8V34A8.02352,8.02352,0,0,1,22,26Z"></path>
  <path fill="#3b99c9" fill-rule="evenodd" d="M24,30H96a6.01764,6.01764,0,0,1,6,6V70a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V36A6.01764,6.01764,0,0,1,24,30Z"></path>
  <g>
    <path fill-rule="evenodd" d="M24,37H96a6.01764,6.01764,0,0,1,6,6V55a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V43A6.01764,6.01764,0,0,1,24,37Z"></path>
    <path fill="#ffb003" fill-rule="evenodd" d="M24,37H96a6.01764,6.01764,0,0,1,6,6V55a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V43A6.01764,6.01764,0,0,1,24,37Z"></path>
  </g>
  <g>
    <path fill-rule="evenodd" d="M24,44H96a6.01764,6.01764,0,0,1,6,6V62a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V50A6.01764,6.01764,0,0,1,24,44Z"></path>
    <path fill="#50be3d" fill-rule="evenodd" d="M24,44H96a6.01764,6.01764,0,0,1,6,6V62a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V50A6.01764,6.01764,0,0,1,24,44Z"></path>
  </g>
  <g>
    <path fill-rule="evenodd" d="M24,51H96a6.01764,6.01764,0,0,1,6,6V69a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V57A6.01764,6.01764,0,0,1,24,51Z"></path>
    <path fill="#f26d5f" fill-rule="evenodd" d="M24,51H96a6.01764,6.01764,0,0,1,6,6V69a6.01764,6.01764,0,0,1-6,6H24a6.01764,6.01764,0,0,1-6-6V57A6.01764,6.01764,0,0,1,24,51Z"></path>
  </g>
  <g>
    <path fill-rule="evenodd" d="M14,58h92V86a8.02352,8.02352,0,0,1-8,8H22a8.02352,8.02352,0,0,1-8-8Zm27,0c9,0,10,11.5,19,11.5S70,58,79,58Z"></path>
    <path fill="#d9d6cc" fill-rule="evenodd" d="M14,58h92V86a8.02352,8.02352,0,0,1-8,8H22a8.02352,8.02352,0,0,1-8-8Zm27,0c9,0,10,11.5,19,11.5S70,58,79,58Z"></path>
  </g>
</svg>
                {/* Google Wallet */}
               ...
               <svg className="size-8" xmlns="http://www.w3.org/2000/svg" width="256" height="256" fill="none" viewBox="0 0 256 256" id="google">
  <rect width="224" height="224" x="16" y="16" fill="#EEE" rx="70"></rect>
  <path fill="#4285F4" d="M192.224 129.249C192.224 123.786 191.78 119.8 190.821 115.666H128.443V140.321H165.058C164.32 146.449 160.333 155.676 151.475 161.877L151.351 162.702L171.073 177.981L172.44 178.117C184.989 166.528 192.224 149.475 192.224 129.249Z"></path>
  <path fill="#34A853" d="M128.443 194.208C146.381 194.208 161.44 188.302 172.439 178.115L151.475 161.875C145.864 165.787 138.335 168.518 128.443 168.518C110.874 168.518 95.9625 156.929 90.647 140.91L89.8679 140.976L69.36 156.848L69.0918 157.593C80.017 179.296 102.458 194.208 128.443 194.208Z"></path>
  <path fill="#FBBC05" d="M90.6476 140.912C89.245 136.779 88.4333 132.349 88.4333 127.773C88.4333 123.195 89.245 118.766 90.5738 114.633L90.5366 113.752L69.7718 97.626L69.0924 97.9491C64.5896 106.955 62.0059 117.069 62.0059 127.773C62.0059 138.476 64.5896 148.589 69.0924 157.595L90.6476 140.912Z"></path>
  <path fill="#EB4335" d="M128.443 87.0221C140.918 87.0221 149.334 92.4109 154.132 96.9142L172.882 78.6068C161.367 67.903 146.381 61.333 128.443 61.333C102.458 61.333 80.017 76.2445 69.0918 97.9473L90.5732 114.631C95.9625 98.6119 110.874 87.0221 128.443 87.0221Z"></path>
</svg>
              </div>
