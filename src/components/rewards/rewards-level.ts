...
export const LEVEL_REQUIREMENTS = [
  0, 1000, 2500, 5000, 10000, 17500, 27500, 40000, 55000, 75000, 100000, 130000,
  165000, 205000, 250000, 300000,
];
...
export const LEVEL_REWARDS: LevelReward[] = [
  {
    ...
    icon: Star,
    reward: "Welcome bonus: 50 XP",
    color: "from-green-400 to-green-600",
  },
  {
    level: 2,
    title: "Learning Sprout",
    description: "You're getting the hang of it!",
    icon: Lightbulb,
    reward: "Bonus daily quest unlock",
  ...
  },
  {
    ...
    icon: Coins,
    reward: "1 week premium access",
    color: "from-blue-400 to-blue-600",
  },
  {
    level: 4,
    title: "Budget Master",
    description: "Mastering your money flow",
    icon: Shield,
    reward: "Budgeting tools unlock",
    color: "from-cyan-400 to-blue-600",
  },
  {
    level: 5,
    title: "Investment Explorer",
    description: "Ready to grow your wealth",
    icon: Rocket,
  ...
  },
  {
    ...
    icon: Shield,
    reward: "Risk assessment tools",
    color: "from-violet-400 to-indigo-600",
  },
  {
    level: 8,
    title: "Portfolio Manager",
    description: "Managing money like a pro",
    icon: Trophy,
    reward: "Advanced course unlock",
    color: "from-indigo-400 to-indigo-600",
  },
  {
    level: 10,
    title: "Financial Strategist",
    description: "Planning long-term wealth",
    icon: Target,
    reward: "2 months premium access",
    color: "from-orange-400 to-red-500",
  },
  {
    level: 12,
    title: "Wealth Builder",
    description: "Creating lasting financial success",
    icon: Crown,
    reward: "3 months premium access",
  ...
  },
  {
    ...
    icon: Gem,
    reward: "1 year premium access",
    color: "from-pink-400 to-rose-500",
  },
  {
    level: 16,
    title: "Money Mastermind",
    description: "Ultimate financial mastery",
    icon: Infinity,
...
export const getCurrentLevelInfo = (xp: number) => {
  ...
  const nextLevelXP =
    ...
    LEVEL_REQUIREMENTS[LEVEL_REQUIREMENTS.length - 1];
