...
export const siteConfig = {
  ...
  description:
    "Moneko is an AI budgeting app and expense tracker for iPhone, Android, WhatsApp, Telegram, and the web. Track spending, organize pockets, and manage shared budgets.",
  url: "https://moneko.io",
