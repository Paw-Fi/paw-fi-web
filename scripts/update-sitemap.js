...
function mergeFixedPublicUrls(xmlContent) {
  ...
  const fixedPages = [
    ...
    ...[
      ...
      "moneko-vs-ynab-2026",
      "7-best-free-ynab-alternatives-2026",
      "8-best-free-bill-splitting-apps-android-2026",
      "8-best-household-budget-apps-2026-couples-families",
      "how-to-automatically-log-apple-pay-transactions-iphone-shortcuts",
      "how-to-automatically-track-expenses-from-email-receipts-2026",
      "how-to-automatically-track-expenses-android-without-bank-sync",
      "how-to-budget-as-couple-separate-bank-accounts",
      "telegram-expense-tracker-best-bots-apps-2026",
      "what-is-rollover-budget-how-to-carry-leftover-money-next-month",
      "whatsapp-expense-tracker-easiest-way-track-spending-2026",
    ].map((slug) => ({
